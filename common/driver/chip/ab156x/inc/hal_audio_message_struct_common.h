...
#define AUDIO_AMP_DELAY_OFF_TIMER_DURATION_MS    (2000) // default: 2s
#else
#define AUDIO_AMP_DELAY_OFF_TIMER_DURATION_MS    (0) // default: 0s
#endif
...
typedef struct {
    ...
    uint32_t codec_type;
    audio_codec_param_t codec_param;
} wireless_mic_rx_bt_link_info_t;
...
typedef struct {
    ...
    int32_t gain_default_L;
    int32_t gain_default_R;
    wireless_mic_rx_bt_link_info_t bt_link_info[4];
} wireless_mic_rx_param_t;
...
typedef union {
    ...
    wireless_mic_rx_param_t wireless_mic_rx_param;
...
typedef union {
    ...
    audio_virtual_open_param_t  virtual;
...
typedef enum {
    ...
    AUDIO_SCENARIO_TYPE_WIRELESS_MIC_RX_UL_I2S_MST_OUT_0,         /**< Audio scenario type audio transmitter wireless microphone receiver I2S master out. */
    ...
    AUDIO_SCENARIO_TYPE_ADVANCED_RECORD_N_MIC,                    /**< Audio scenario type audio transmitter advanced record. */
...
typedef enum {
    ...
    MCU2DSP_SYNC_REQUEST_FADE_OUT,
    MCU2DSP_SYNC_REQUEST_ACTION_MAX = 0xFFFFFFFF
} cm4_dsp_audio_sync_action_type_t;

typedef enum {
    MCU2DSP_SYNC_REQUEST_HFP = 0,
    MCU2DSP_SYNC_REQUEST_A2DP,
    MCU2DSP_SYNC_REQUEST_ANC,
    MCU2DSP_SYNC_REQUEST_VP,
