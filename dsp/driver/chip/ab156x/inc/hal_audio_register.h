...
#define AUDIO_TOP_CON0_PDN_ALL_MASK                 (0x3FCCC304)
...
#define AFE_ADDA_DL_DITHER_CON_SDM_DITHER_EN_POS    (16)
#define AFE_ADDA_DL_DITHER_CON_SDM_DITHER_EN_MASK   (1<<AFE_ADDA_DL_DITHER_CON_SDM_DITHER_EN_POS)
...
#define MEM_ASRC_TOP_CON0_MASM1_SFT_RST_POS         (0)
#define MEM_ASRC_TOP_CON0_MASM1_SFT_RST_MASK        (1<<MEM_ASRC_TOP_CON0_MASM1_SFT_RST_POS)
...
#define AUDDEC_ANA_CON15_SET_LCH_INPUT_PULL_HIGH_POS (12)
#define AUDDEC_ANA_CON15_SET_LCH_INPUT_PULL_HIGH_MASK (1<<AUDDEC_ANA_CON15_SET_LCH_INPUT_PULL_HIGH_POS)
 ...
 *****************************************************************************/
#define ANC_CTL0                    (ANC_BASE + 0x0000)
#define ANC_CTL1                    (ANC_BASE + 0x0004)
#define ANC_CTL2                    (ANC_BASE + 0x0008)
#define ANC_CTL3                    (ANC_BASE + 0x000c)
#define ANC_CTL4                    (ANC_BASE + 0x0010)
#define ANC_CTL5                    (ANC_BASE + 0x0014)
#define ANC_CTL6                    (ANC_BASE + 0x0018)
#define ANC_CTL7                    (ANC_BASE + 0x001c)
#define ANC_CTL8                    (ANC_BASE + 0x0020)
#define ANC_MIC_SET0                (ANC_BASE + 0x0024)
#define ANC_MIC_SET1                (ANC_BASE + 0x0028)
#define ANC_MIC_SET2                (ANC_BASE + 0x002c)
#define ANC_MIC_SET3                (ANC_BASE + 0x0030)
#define ANC_DGAIN_SET0              (ANC_BASE + 0x0034)
#define ANC_DGAIN_SET1              (ANC_BASE + 0x0038)
#define ANC_DGAIN_SET2              (ANC_BASE + 0x003c)
#define ANC_BIQ_INP_SET_CH01        (ANC_BASE + 0x0040)
#define ANC_BIQ_INP_SET_CH23        (ANC_BASE + 0x0044)
#define ANC_BIQ_INP_SET_CH45        (ANC_BASE + 0x0048)
#define ANC_BIQ_OUT_GAIN_CH0        (ANC_BASE + 0x004c)
#define ANC_BIQ_OUT_GAIN_CH1        (ANC_BASE + 0x0050)
#define ANC_BIQ_OUT_GAIN_CH2        (ANC_BASE + 0x0054)
#define ANC_BIQ_OUT_GAIN_CH3        (ANC_BASE + 0x0058)
#define ANC_BIQ_OUT_GAIN_CH4        (ANC_BASE + 0x005c)
#define ANC_BIQ_OUT_GAIN_CH5        (ANC_BASE + 0x0060)
#define ANC_BIQ_COEF_SET_CH01       (ANC_BASE + 0x0064)
#define ANC_BIQ_COEF_SET_CH23       (ANC_BASE + 0x0068)
#define ANC_BIQ_COEF_SET_CH45       (ANC_BASE + 0x006c)
#define ANC_CIC1_SET                (ANC_BASE + 0x0070)

#define ANC_LIMITER_OTHD0_CH0       (ANC_BASE + 0x00c0)
#define ANC_LIMITER_OTHD1_CH0       (ANC_BASE + 0x00c4)
#define ANC_LIMITER_OTHD0_CH1       (ANC_BASE + 0x00c8)
#define ANC_LIMITER_OTHD1_CH1       (ANC_BASE + 0x00cc)
#define ANC_LIMITER_OTHD0_CH2       (ANC_BASE + 0x00d0)
#define ANC_LIMITER_OTHD1_CH2       (ANC_BASE + 0x00d4)
#define ANC_LIMITER_OTHD0_CH3       (ANC_BASE + 0x00d8)
#define ANC_LIMITER_OTHD1_CH3       (ANC_BASE + 0x00dc)
#define ANC_LIMITER_A10_CH0         (ANC_BASE + 0x00e0)
#define ANC_LIMITER_A11_CH0         (ANC_BASE + 0x00e4)
#define ANC_LIMITER_A2_CH0          (ANC_BASE + 0x00e8)
#define ANC_LIMITER_A3_CH0          (ANC_BASE + 0x00ec)
#define ANC_LIMITER_A10_CH1         (ANC_BASE + 0x00f0)
#define ANC_LIMITER_A11_CH1         (ANC_BASE + 0x00f4)
#define ANC_LIMITER_A2_CH1          (ANC_BASE + 0x00f8)
#define ANC_LIMITER_A3_CH1          (ANC_BASE + 0x00fc)
#define ANC_LIMITER_A10_CH2         (ANC_BASE + 0x0100)
#define ANC_LIMITER_A11_CH2         (ANC_BASE + 0x0104)
#define ANC_LIMITER_A2_CH2          (ANC_BASE + 0x0108)
#define ANC_LIMITER_A3_CH2          (ANC_BASE + 0x010c)
#define ANC_LIMITER_A10_CH3         (ANC_BASE + 0x0110)
#define ANC_LIMITER_A11_CH3         (ANC_BASE + 0x0114)
#define ANC_LIMITER_A2_CH3          (ANC_BASE + 0x0118)
#define ANC_LIMITER_A3_CH3          (ANC_BASE + 0x011c)
#define ANC_LIMITER_SET0            (ANC_BASE + 0x0120)

#define ANC_RAMP_CH0_SET0           (ANC_BASE + 0x0124)
#define ANC_RAMP_CH0_SET1           (ANC_BASE + 0x0128)
#define ANC_RAMP_CH0_SET2           (ANC_BASE + 0x012c)
#define ANC_RAMP_CH0_DBG0           (ANC_BASE + 0x0130)
#define ANC_RAMP_CH1_SET0           (ANC_BASE + 0x0134)
#define ANC_RAMP_CH1_SET1           (ANC_BASE + 0x0138)
#define ANC_RAMP_CH1_SET2           (ANC_BASE + 0x013c)
#define ANC_RAMP_CH1_DBG0           (ANC_BASE + 0x0140)
#define ANC_RAMP_CH2_SET0           (ANC_BASE + 0x0144)
#define ANC_RAMP_CH2_SET1           (ANC_BASE + 0x0148)
#define ANC_RAMP_CH2_SET2           (ANC_BASE + 0x014c)
#define ANC_RAMP_CH2_DBG0           (ANC_BASE + 0x0150)
#define ANC_RAMP_CH3_SET0           (ANC_BASE + 0x0154)
#define ANC_RAMP_CH3_SET1           (ANC_BASE + 0x0158)
#define ANC_RAMP_CH3_SET2           (ANC_BASE + 0x015c)
#define ANC_RAMP_CH3_DBG0           (ANC_BASE + 0x0160)

#define ANC_OUT_MIXER_SET0          (ANC_BASE + 0x0164)
#define ANC_CLASSG_SET0             (ANC_BASE + 0x0168)
#define ANC_CLASSG_SET1             (ANC_BASE + 0x016c)
#define ANC_CLASSG_SET2             (ANC_BASE + 0x0170)
#define ANC_DEQ_DLY_SET0            (ANC_BASE + 0x0174)
#define ANC_SDM_SET0                (ANC_BASE + 0x0178)
#define ANC_CMEM_ADDR               (ANC_BASE + 0x0200)
#define ANC_CMEM_WDAT_B0            (ANC_BASE + 0x0204)
#define ANC_CMEM_WDAT_B1            (ANC_BASE + 0x0208)
#define ANC_CMEM_WDAT_B2            (ANC_BASE + 0x020c)
#define ANC_CMEM_WDAT_A1            (ANC_BASE + 0x0210)
#define ANC_CMEM_WDAT_A2            (ANC_BASE + 0x0214)
#define ANC_CMEM_CE                 (ANC_BASE + 0x0218)
#define ANC_CMEM_RDONE_CH01         (ANC_BASE + 0x021c)
#define ANC_CMEM_RDAT_B0_CH01       (ANC_BASE + 0x0220)
#define ANC_CMEM_RDAT_B1_CH01       (ANC_BASE + 0x0224)
#define ANC_CMEM_RDAT_B2_CH01       (ANC_BASE + 0x0228)
#define ANC_CMEM_RDAT_A1_CH01       (ANC_BASE + 0x022c)
#define ANC_CMEM_RDAT_A2_CH01       (ANC_BASE + 0x0230)
#define ANC_CMEM_RDONE_CH23         (ANC_BASE + 0x0234)
#define ANC_CMEM_RDAT_B0_CH23       (ANC_BASE + 0x0238)
#define ANC_CMEM_RDAT_B1_CH23       (ANC_BASE + 0x023c)
#define ANC_CMEM_RDAT_B2_CH23       (ANC_BASE + 0x0240)
#define ANC_CMEM_RDAT_A1_CH23       (ANC_BASE + 0x0244)
#define ANC_CMEM_RDAT_A2_CH23       (ANC_BASE + 0x0248)
#define ANC_CMEM_RDONE_CH45         (ANC_BASE + 0x024c)
#define ANC_CMEM_RDAT_B0_CH45       (ANC_BASE + 0x0250)
#define ANC_CMEM_RDAT_B1_CH45       (ANC_BASE + 0x0254)
#define ANC_CMEM_RDAT_B2_CH45       (ANC_BASE + 0x0258)
#define ANC_CMEM_RDAT_A1_CH45       (ANC_BASE + 0x025c)
#define ANC_CMEM_RDAT_A2_CH45       (ANC_BASE + 0x0260)
#define ANC_BIQ_ERR_STATUS          (ANC_BASE + 0x0264)
#define ANC_BIQ_ERR_CTL             (ANC_BASE + 0x0268)

#define ANC_DBG_SET                 (ANC_BASE + 0x0300)
#define ANC_CR_RDATA                (ANC_BASE + 0x0304)
#define DFX_CR_RDATA_CH01           (ANC_BASE + 0x0308)
#define DFX_CR_RDATA_CH23           (ANC_BASE + 0x030c)
#define DFX_CR_RDATA_CH45           (ANC_BASE + 0x0310)

/*need to check if offset changes or not*/
#define ANC_PWR_DETECT_CUR_PWR_LCH  (AFE_BASE + 0x0C64)
#define ANC_PWR_DETECT_CUR_PWR_RCH  (AFE_BASE + 0x0C68)
 ...
 *****************************************************************************/
#define VOW_CTRL_BASE 0xA4000000
#define VOW_SRAM_BASE 0xA4010000
...
#define    INFRA_MISC_CFG_BASE     0xA2200000
#define    NFRA_CFG_PERI2          (INFRA_MISC_CFG_BASE+0x0068)
