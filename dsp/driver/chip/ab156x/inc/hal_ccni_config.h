...
/**@brief Event2 had been used on AUDIO_BT_CONTROLLER_TX. */
#define CCNI_DSP0_TO_CM4_AUDIO_BT_CONTROLLER_TX      (CCNI_EVENT_SRC_DSP0|CCNI_EVENT_DST_CM4|HAL_CCNI_EVENT2)
/**@brief Event3 had been used on AUDIO_BT_CONTROLLER_RX. */
#define CCNI_DSP0_TO_CM4_AUDIO_BT_CONTROLLER_RX      (CCNI_EVENT_SRC_DSP0|CCNI_EVENT_DST_CM4|HAL_CCNI_EVENT3)
/**@brief Event4 is in default status. */
