...
void sleep_management_dump_sleep_handle_name(uint8_t handle_index)
{
    switch (handle_index) {
        case 0  :
            ...
            break;
        case 1  :
            log_hal_msgid_info("sleep handle=%d,SFC\r\n", 1, (int)handle_index);
            break;
        case 2  :
            log_hal_msgid_info("sleep handle=%d,I2S0\r\n", 1, (int)handle_index);
            break;
        case 3  :
            log_hal_msgid_info("sleep handle=%d,I2S1\r\n", 1, (int)handle_index);
            break;
        case 4  :
            log_hal_msgid_info("sleep handle=%d,I2S2\r\n", 1, (int)handle_index);
            break;
        case 5  :
            log_hal_msgid_info("sleep handle=%d,I2S3\r\n", 1, (int)handle_index);
            break;
        case 6  :
        ...
        if (((wakeup_source >> i) & 0x01) == 0) {
            switch (i) {
                ...
                case 5  :
                    ...
                    break;
                case 6  :
                    log_hal_msgid_info("[Sleep Management]WAKEUP_SOURCE : I2S_DMA\r\n", 0);
                    break;
                case 7  :
                    log_hal_msgid_info("[Sleep Management]WAKEUP_SOURCE : CAP_TOUCH\r\n", 0);
                    break;
                case 8  :
                    log_hal_msgid_info("[Sleep Management]WAKEUP_SOURCE : ANC\r\n", 0);
                    break;
                case 9  :
                    log_hal_msgid_info("[Sleep Management]WAKEUP_SOURCE : SPI_SLAVE\r\n", 0);
                    break;
                case 10 :
                    log_hal_msgid_info("[Sleep Management]WAKEUP_SOURCE : RGU\r\n", 0);
                    break;
                case 11 :
                    log_hal_msgid_info("[Sleep Management]WAKEUP_SOURCE : NONE\r\n", 0);
                    break;
                case 12 :
                    log_hal_msgid_info("[Sleep Management]WAKEUP_SOURCE : DSP_DMA\r\n", 0);
                    break;
                default :
                    break;
            }
        ...
        if (((eint_num >> i) & 0x01) == 0x01) {
            ...
            switch (i) {
                ...
                case 26 :
                    ...
                    break;
                case 27 :
                    log_hal_msgid_info("[Sleep Management]EINT_PDN_USB\r\n", 0);
                    break;
                case 28 :
                    log_hal_msgid_info("[Sleep Management]EINT_PMU_IRQ\r\n", 0);
                    break;
                case 29 :
                    log_hal_msgid_info("[Sleep Management]EINT_IR_WAK_AP\r\n", 0);
                    break;
                case 30 :
                    log_hal_msgid_info("[Sleep Management]EINT_CONN2AP_WDT_IRQ\r\n", 0);
                    break;
                case 31 :
                    log_hal_msgid_info("[Sleep Management]EINT_CONN2AP_WAKEUP_OUT\r\n", 0);
                    break;
            }
        }
    }
