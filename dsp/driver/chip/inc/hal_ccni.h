 ...
 *      (A) Check the event usage status in \\dsp\\driver\\chip\\ab155x\\dsp0\\inc\\hal_ccni_config.h. The event in default status can be used.\n
 ...
 *
 *  - Step 3: Replace the event name in \\dsp\\driver\\chip\\ab155x\\dsp0\\inc\\hal_ccni_config.h for DSP0. \n
 *            Replace the event name in \\dsp\\driver\\chip\\ab155x\\dsp1\\inc\\hal_ccni_config.h for DSP1. \n
 ...
 *    @endcode
 *
 * - Step 5: Register the isr handler to ccni_*_to_*_function_table[] in \\dsp\\driver\\chip\\ab155x\\dsp0\\src\\hal_ccni_config.c for DSP0. \n
 *           Register the isr handler to ccni_*_to_*_function_table[] in \\dsp\\driver\\chip\\ab155x\\dsp1\\src\\hal_ccni_config.c for DSP1. \n 
