 ...
 *           - Memory address and length should match below align requirement. But IRAM only
 *             supports 4 bytes align with single burst and 16 bytes align with 4-beat burst.
 *      |---------------------------------------------------------------------------|
 ...
 *                      ATTR_ZIDATA_IN_DRAM_4BYTE_ALIGN, if the array has no initial value.
 *                      ATTR_RWDATA_IN_DRAM_4BYTE_ALIGN, if the array has an initial value.
 *             Example: ATTR_ZIDATA_IN_DRAM_4BYTE_ALIGN static uint8_t  source_address[data_length];
 *                      ATTR_ZIDATA_IN_DRAM_4BYTE_ALIGN static uint8_t  destination_address[data_length];
 ...
 *       ATTR_ZIDATA_IN_DRAM_4BYTE_ALIGN static uint8_t  source_address[64];
 *       ATTR_ZIDATA_IN_DRAM_4BYTE_ALIGN static uint8_t  destination_address[64];
