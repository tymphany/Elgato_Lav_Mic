...
#ifndef __COMPONENTINTERNAL__
#define __COMPONENTINTERNAL__
...
#define DSP_MM_ASSERT(x)  assert(x)

typedef enum{
    REGION_START = 0XABAB0000, 
    REGION_IRAM,
    REGION_DRAM,
    REGION_SYSRAM,
}MemoryType_t;
