...
ifeq ($(AIR_LOW_LANTENCY_MUX_ENABLE),y)
KERNEL_SERVICE_MUX_FILES += $(KERNEL_MUX_SRC)/mux_ll_uart.c
KERNEL_SERVICE_MUX_FILES += $(KERNEL_MUX_SRC)/mux_ringbuffer.c
CCFLAG += -DAIR_LOW_LANTENCY_MUX_ENABLE
endif #AIR_LOW_LANTENCY_MUX_ENABLE

C_SRC += $(KERNEL_SERVICE_MUX_FILES)

###################################################
# include path
INC += kernel/service/mux/inc
