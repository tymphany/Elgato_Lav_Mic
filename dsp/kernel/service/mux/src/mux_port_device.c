...
void mux_driver_debug_for_check(virtual_read_write_point_t *p)
{
    ...
    if (flag != 0) {
        ...
        if ((flag & 0x7F) != 0) {
            MUX_PORT_MSGID_E("p->rx_buff_start:0x%x 0x%x", 1, (unsigned int)p->rx_buff_start);
            MUX_PORT_MSGID_E("p->rx_buff_len:0x%x 0x%x", 1, (unsigned int)p->rx_buff_len);
            MUX_PORT_MSGID_E("p->rx_buff_end:0x%x 0x%x", 1, (unsigned int)p->rx_buff_end);
            MUX_PORT_MSGID_E("p->rx_buff_read_point:0x%x 0x%x", 1, (unsigned int)p->rx_buff_read_point);
            MUX_PORT_MSGID_E("p->rx_buff_write_point:0x%x 0x%x", 1, (unsigned int)p->rx_buff_write_point);
            MUX_PORT_MSGID_E("p->rx_buff_available_len:0x%x 0x%x", 1, (unsigned int)p->rx_buff_available_len);
            MUX_PORT_MSGID_E("p->rx_receiving_write_point:0x%x 0x%x", 1, (unsigned int)p->rx_receiving_write_point);
        }
        if ((flag & 0x3F80) != 0) {
            MUX_PORT_MSGID_E("p->tx_buff_start:0x%x 0x%x", 1, (unsigned int)p->tx_buff_start);
            MUX_PORT_MSGID_E("p->tx_buff_len:0x%x 0x%x", 1, (unsigned int)p->tx_buff_len);
            MUX_PORT_MSGID_E("p->tx_buff_end:0x%x 0x%x", 1, (unsigned int)p->tx_buff_end);
            MUX_PORT_MSGID_E("p->tx_buff_read_point:0x%x 0x%x", 1, (unsigned int)p->tx_buff_read_point);
            MUX_PORT_MSGID_E("p->tx_buff_write_point:0x%x 0x%x", 1, (unsigned int)p->tx_buff_write_point);
            MUX_PORT_MSGID_E("p->tx_buff_available_len:0x%x 0x%x", 1, (unsigned int)p->tx_buff_available_len);
            MUX_PORT_MSGID_E("p->tx_sending_read_point:0x%x 0x%x", 1, (unsigned int)p->tx_sending_read_point);
        }
    }
}
