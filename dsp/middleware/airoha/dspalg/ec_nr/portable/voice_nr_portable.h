...
#endif
#if defined(AIR_ECNR_1MIC_INEAR_ENABLE) || defined(AIR_ECNR_2MIC_INEAR_ENABLE) || defined(AIR_AI_NR_PREMIUM_INEAR_ENABLE)
...
#ifdef AIR_3RD_PARTY_NR_ENABLE
void Voice_EC_Init(int NB_mode, void *p_ecnr_mem_ext, void *p_ecnr_NvKey, S16 *NR_gain);
...
void Voice_EC_Inear_Init(int NB_mode, void *p_ecnr_mem_ext, void *p_ecnr_NvKey, S16 *NR_gain);
...
#else
int AEC_NR_Write_FLASH(S16 *bufou);
void EQ_update(void *p_ecnr_mem_ext, void *p_rxeq_NvKey);
int get_txnr_pitch_last(void);
int TWO_MIC_WB_Write_FLASH(S16 *);
void IE_EC_REF_GAIN_READBACK(S16 *gain);
#ifdef AIR_ECNR_1MIC_INEAR_ENABLE
void Voice_WB_TX_Inear_Init(int NB_mode, S16 *bufin, void *p_ecnr_mem_ext, void *p_ecnr_NvKey, void *p_txeq_NvKey, void *p_InEarEQ_NvKey, void *p_AstEQ_NvKey);
void Voice_WB_TX_Inear_Prcs(S16 *MIC1, S16 *MIC2, S16 *REF, S16 *NR, ECNR_OUT *PAR, S16 *g_f_wind, S16 *mic_status_o);
void Get_AirDump_Inear(S16 *out);
#elif defined(AIR_ECNR_2MIC_INEAR_ENABLE)
...
void Voice_WB_TX_Inear_Init_V2(int NB_mode, S16 *bufin, void *p_ecnr_mem_ext, void *p_ecnr_NvKey, void *p_txeq_NvKey, void *p_InEarEQ_NvKey, void *p_ast_eq_nvkey);
...
#define get_ECNR_SVN                ((p_get_ECNR_SVN)g_ecnr_decoder_export_parameters[0])
#define get_aec_nr_memsize          ((p_get_aec_nr_memsize)g_ecnr_decoder_export_parameters[1])
#define Voice_WB_TX_Inear_Init      ((p_Voice_WB_TX_Inear_Init)g_ecnr_decoder_export_parameters[2])
#define Voice_WB_TX_Inear_Prcs      ((p_Voice_WB_TX_Inear_Prcs)g_ecnr_decoder_export_parameters[3])
...
#define EC_PreLim_Coef_READBACK     ((p_EC_PreLim_Coef_READBACK)g_ecnr_decoder_export_parameters[9])
#define AEC_NR_Write_FLASH          ((p_AEC_NR_Write_FLASH)g_ecnr_decoder_export_parameters[10])
#define EQ_update                   ((p_EQ_update)g_ecnr_decoder_export_parameters[11])
#define get_txnr_pitch_last         ((p_get_txnr_pitch_last)g_ecnr_decoder_export_parameters[12])
#define DaulMIC_power_Coef_READBACK ((p_DaulMIC_power_Coef_READBACK)g_ecnr_decoder_export_parameters[13])
#define TWO_MIC_WB_Write_FLASH      ((p_TWO_MIC_WB_Write_FLASH)g_ecnr_decoder_export_parameters[14])
#define IE_EC_REF_GAIN_READBACK     ((p_IE_EC_REF_GAIN_READBACK)g_ecnr_decoder_export_parameters[15])
#define Get_AirDump_Inear           ((p_Get_AirDump_Inear)g_ecnr_decoder_export_parameters[16])
...
#define PF_GAIN_FB_READBACK         ((p_PF_GAIN_FB_READBACK)g_ecnr_decoder_export_parameters[16])
...
typedef int (*p_Assign_EC_RXNR_scratch_memory)(void *p_ecnr_mem_ext);
/* EC */
#ifndef AIR_VOICE_NR_USE_HYBRID_PIC_ENABLE
