...
#ifdef AIR_BTA_IC_PREMIUM_G2
        prev_ec_Voice_EC120_Init(VOICE_WB, g_voice_ecnr_ec_para->ScratchMemory, &g_voice_ecnr_ec_para->nvkey_aec_nr, (int16_t *)&g_voice_ecnr_ec_para->nvkey_aec_nr.WB_NR_TX_NOISE_GAIN_LIMITER);
#elif defined(AIR_BTA_IC_PREMIUM_G3)
        if (gDspAlgParameter.EscoMode.Tx == VOICE_SWB) {
            ...
            prev_ec_Voice_EC120_Init(VOICE_WB, g_voice_ecnr_ec_para->ScratchMemory, &g_voice_ecnr_ec_para->nvkey_aec, (int16_t *)&g_voice_ecnr_ec_para->nvkey_nr.WB_NR_TX_NOISE_GAIN_LIMITER);
        }
#endif
    } else if (g_voice_ecnr_ec_period == 5000) {
#ifdef AIR_BTA_IC_PREMIUM_G2
        prev_ec_Voice_EC80_Init(VOICE_WB, g_voice_ecnr_ec_para->ScratchMemory, &g_voice_ecnr_ec_para->nvkey_aec_nr, (int16_t *)&g_voice_ecnr_ec_para->nvkey_aec_nr.WB_NR_TX_NOISE_GAIN_LIMITER);
#elif defined(AIR_BTA_IC_PREMIUM_G3)
        if (gDspAlgParameter.EscoMode.Tx == VOICE_SWB) {
            ...
            prev_ec_Voice_EC80_Init(VOICE_WB, g_voice_ecnr_ec_para->ScratchMemory, &g_voice_ecnr_ec_para->nvkey_aec, (int16_t *)&g_voice_ecnr_ec_para->nvkey_nr.WB_NR_TX_NOISE_GAIN_LIMITER);
        }
#endif
    } else {
        AUDIO_ASSERT(0);
...
#ifdef AIR_BTA_IC_PREMIUM_G2
    g_voice_ecnr_nvkey_aec = &g_voice_ecnr_ec_para->nvkey_aec_nr;
#elif defined(AIR_BTA_IC_PREMIUM_G3)
...
#ifdef AIR_BTA_IC_PREMIUM_G2
    g_voice_ecnr_nvkey_aec = &g_voice_ecnr_postec_para->nvkey_aec_nr;
#elif defined(AIR_BTA_IC_PREMIUM_G3)
...
voice_ecnr_status_t voice_ecnr_ec_postec_init(void *para)
{
    ...
    #if defined(AIR_VOICE_NR_USE_PIC_ENABLE) && defined(AIR_BTA_IC_PREMIUM_G3)
