...
#define ROM_TABLE_LC3_LEN       61440
#define ROM_TABLE_LC3_PLUS_LEN  70688
#define ROM_TABLE_OPUS_LEN      19760
#define ROM_TABLE_WIND_DET_LEN  9488
#define ROM_TABLE_IGO_AINR_LEN  236288
#endif
...
#define ROM_TABLE_LC3_PLUS_LEN  70688
#define ROM_TABLE_WIND_DET_LEN  9488
#define ROM_TABLE_IGO_AINR_LEN  291072
#endif
...
typedef struct PACKED stru_dsp_rom_table_para_s {
    ...
    CONST U8 rom_table_igo_ainr[ROM_TABLE_IGO_AINR_LEN];
...
#define ROM_TABLE_ADDR_IGO_AINR ((void*)&(((DSP_ROM_TABLE_PARA_STRU_PTR)ROM_TABLE_BASE)->rom_table_igo_ainr))
