...
/* Public functions ----------------------------------------------------------*/
sw_buffer_port_t *stream_function_sw_buffer_get_port(void *owner)
{
    int32_t i;
...
sw_buffer_port_t *stream_function_sw_buffer_get_unused_port(void *owner)
{
    int32_t i;
    sw_buffer_port_t *port = NULL;
    uint32_t saved_mask;
...
sw_buffer_status_t stream_function_sw_buffer_reset_channel_buffer(sw_buffer_port_t *port, uint16_t channel_number, bool set_zeros)
{
    sw_buffer_channel_t *channel;
    uint32_t saved_mask;
...
sw_buffer_list_t *stream_function_sw_buffer_get_list(void *owner)
{
    int32_t i;
...
sw_buffer_status_t stream_function_sw_buffer_list_insert_buffer(sw_buffer_list_t *list, sw_buffer_port_t *port, uint16_t buffer_index)
{
    uint32_t saved_mask;
...
#if SW_BUFFER_DEBUG_DUMP
    LOG_AUDIO_DUMP((uint8_t *)stream_function_get_inout_buffer(para, 1),
        in_frame_size,
        VOICE_TX_MIC_2);
#endif /* SW_BUFFER_DEBUG_DUMP */
