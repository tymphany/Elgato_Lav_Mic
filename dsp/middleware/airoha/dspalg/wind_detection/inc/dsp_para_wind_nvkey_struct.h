...
/**
* @NvkeyDefine NVID_DSP_ALG_ANC_WIND_DET
...
typedef struct stru_dsp_wind_para_s {
    ...
    S16 w_thr1;                     /**< @Value   9000 @Desc 0.25; smooth wind sec thr.  (0 ~ 32767)        */
    ...
    S32 c_thr0;                     /**< @Value  16000000 @Desc smooth energy first thr                        */
