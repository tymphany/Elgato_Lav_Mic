...
HWVAD_STA hwvad_init(hwvad_config_t config)
{
    ...
    DSP_MW_LOG_I("[HWVAD] mic_selection: %d, mic_interface: %d, mic1_selection: %d, mic1_interface: %d", 4, hwvad_vow_control.mic_selection, hwvad_vow_control.mic_interface, hwvad_vow_control.mic1_selection, hwvad_vow_control.mic1_interface);
    ...
    DSP_MW_LOG_I("[HWVAD] init OK,adda_analog_mic_mode = %d", 1, hwvad_vow_control.adc_parameter.adc_mode);
    return HWVAD_OK;
}
