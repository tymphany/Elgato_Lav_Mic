...
typedef enum {
    ...
    CODEC_DECODER_VENDOR_3  = 0x0D,             /**< decoder type: Vendor 3 defined. */
 ...
 *  Declare all of feature list at dsp_sdk.c \n
 *  Each feature list must begin with \b codec and end with #FUNC_END.
 *  Stream feature list for HFP downlink with CVSD.\n
 *  {\n
 *      #CODEC_PCM_COPY, \n
 ...
 *  Declare all of feature list at dsp_sdk.c \n
 *  Each feature list must begin with \b codec and end with #FUNC_END.
 *  Stream feature list for HFP downlink with MSBC.\n
 *  {\n
 *      #CODEC_DECODER_MSBC, \n
 *      #FUNC_PLC, \n
 *      #FUNC_RX_NR,\n
...
EXTERN stream_feature_list_t AudioFeatureList_WirelessMic[];
/**<
 *  Declare all of feature list at dsp_sdk.c \n
 *  Each feature list must begin with \b codec and end with #FUNC_END.
