 ...
 * Filename:
 * ---------
 *  dsp_drv_analog_type.h
 *
 * Project:
 * --------
 *   AB155x  Audio Driver Kernel Function
 *
 * Description:
 * ------------
 *   Audio register
...
#ifndef __AUDIO_ANALOG_TYPE_H__
#define __AUDIO_ANALOG_TYPE_H__
...
} ab155x_Codec_Data_Priv;


#endif /* __AUDIO_ANALOG_TYPE_H__ */
