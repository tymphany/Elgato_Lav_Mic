...
C_SRC += $(DSPFW_PATH)/src/dsp_upper_layer/davt/davt.c
C_SRC += $(DSPFW_PATH)/src/dsp_upper_layer/dhpt/dhpt.c
C_SRC += $(DSPFW_PATH)/src/dsp_upper_layer/dprt/dprt.c
C_SRC += $(DSPFW_PATH)/src/dsp_upper_layer/dllt/dllt.c
ifeq ($(AIR_AUDIO_I2S_SLAVE_TDM_ENABLE),y)
ifeq ($(AIR_AUDIO_I2S_SLAVE_TDM_TASK_ENABLE),y)
C_SRC += $(DSPFW_PATH)/src/dsp_upper_layer/dtdmt/dtdmt.c
endif
endif
...
C_SRC += $(DSPFW_PATH)/src/dsp_upper_layer/ddchst/ddchst.c
endif
