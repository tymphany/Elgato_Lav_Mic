...
VOID DSP_Init(VOID)
{
...
#else
    xTaskCreate((TaskFunction_t)DSP_AV_Task, "DAV_TASK", 0x2D00 / sizeof(StackType_t), pvTaskParameter, TASK_PRIORITY_NORMAL, &pDAV_TaskHandler);
#endif
#if defined(MTK_GAMING_MODE_HEADSET) || defined(AIR_GAMING_MODE_DONGLE_ENABLE) || defined(AIR_BLE_AUDIO_DONGLE_ENABLE) || defined(AIR_ULL_AUDIO_V2_DONGLE_ENABLE) || defined(AIR_ULL_BLE_HEADSET_ENABLE) || defined(AIR_WIRELESS_MIC_RX_ENABLE)
    ...
    xTaskCreate((TaskFunction_t)DSP_TDM_Task, "DTDM_TASK", 0x1400 / sizeof(StackType_t), pvTaskParameter, TASK_PRIORITY_HIGH, &pDTDM_TaskHandler);
#endif
#ifdef AIR_DCHS_MODE_ENABLE
    xTaskCreate((TaskFunction_t)DSP_DCHS_Task, "DDCHS_TASK", 0x1000 / sizeof(StackType_t), pvTaskParameter, TASK_PRIORITY_HIGH, &pDDCHS_TaskHandler);
#endif
