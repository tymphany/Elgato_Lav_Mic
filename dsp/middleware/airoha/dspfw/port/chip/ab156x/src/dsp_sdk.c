...
#endif
#ifdef AIR_VOICE_DRC_ENABLE
    {FUNC_RX_SWB_DRC,                                                      624,                          0,      stream_function_drc_voice_rx_swb_initialize,           stream_function_drc_voice_rx_process},/*0x66 FUNC_RX_WB_DRC,       */
    {FUNC_TX_SWB_DRC,                                                      624,                          0,      stream_function_drc_voice_tx_swb_initialize,           stream_function_drc_voice_tx_process},/*0x67 FUNC_TX_WB_DRC,       */
#else
...
#endif
#if defined(AIR_WIRED_AUDIO_ENABLE) && defined(MTK_LINEIN_PEQ_ENABLE)
...
#ifdef AIR_WIRELESS_MIC_TX_ENABLE
stream_feature_list_t AudioFeatureList_WirelessMic[] = {
    CODEC_PCM_COPY,
    FUNC_MIC_SW_GAIN,
#ifdef AIR_LD_NR_ENABLE
    FUNC_LD_NR,
...
stream_feature_list_t stream_feature_list_wired_audio_line_in[] = {
    CODEC_PCM_COPY,
    FUNC_CH_SEL,
#ifdef MTK_LINEIN_INS_ENABLE
    FUNC_INS,
...
stream_feature_list_t stream_feature_list_wired_audio_usb_in_0_iem[] = {
    CODEC_PCM_COPY,
    FUNC_CH_SEL,
#ifdef AIR_SOFTWARE_GAIN_ENABLE
    FUNC_SW_GAIN,
...
stream_feature_list_t stream_feature_list_wired_audio_usb_out_iem[] = {
    CODEC_PCM_COPY,
#ifdef AIR_SOFTWARE_GAIN_ENABLE
    FUNC_SW_GAIN,
#endif
...
stream_feature_list_t stream_feature_list_wired_audio_line_out[] = {
    CODEC_PCM_COPY,
#if defined(AIR_FIXED_RATIO_SRC)
    FUNC_SRC_FIXED_RATIO,
#endif
...
stream_feature_list_t stream_feature_list_wired_audio_usb_in_out_iem[] = {
    CODEC_PCM_COPY,
    //FUNC_MIC_SW_GAIN,
    #ifdef AIR_SOFTWARE_MIXER_ENABLE
    FUNC_SW_MIXER,
