...
#if defined(AIR_HEARING_AID_ENABLE)
    aud_msg_rx_register_callback(MSG_MCU2DSP_PSAP_OPEN,  dsp_psap_open, 2);
    aud_msg_rx_register_callback(MSG_MCU2DSP_PSAP_START, dsp_psap_start, 2);
    aud_msg_rx_register_callback(MSG_MCU2DSP_PSAP_STOP,  dsp_psap_stop, 1);
    aud_msg_rx_register_callback(MSG_MCU2DSP_PSAP_CLOSE, dsp_psap_close, 2);
    aud_msg_rx_register_callback(MSG_MCU2DSP_PSAP_SUSPEND, dsp_psap_suspend, 2);
    aud_msg_rx_register_callback(MSG_MCU2DSP_PSAP_RESUME, dsp_psap_resume, 2);
    aud_msg_rx_register_callback(MSG_MCU2DSP_PSAP_CONFIG, dsp_psap_runtime_config, 2);
#endif
