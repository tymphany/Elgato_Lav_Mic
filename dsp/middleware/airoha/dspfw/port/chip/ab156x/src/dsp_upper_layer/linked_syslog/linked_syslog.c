...
ATTR_LOG_STRING_LIB  g_ANC_msg_id_string_118[] = LOG_DEBUG_PREFIX(anc) "DSP adapt_anc_dma OFFSET! G0 cur:0x%x, base:0x%x, diff:0x%x;";
...
ATTR_LOG_STRING_LIB  g_ANC_msg_id_string_123[] = LOG_DEBUG_PREFIX(anc) "hal_anc_set_dma enable:%d";
...
ATTR_LOG_STRING_LIB  g_FA_ANC_msg_id_string_1[] = LOG_DEBUG_PREFIX(full_adapt_anc) "[Full Adapt ANC]Initialize ANC_PARA(%d)(%d)(%d)(%d)(%d)(%d), debug mode(%d)";
...
ATTR_LOG_STRING_LIB  g_FA_ANC_msg_id_string_5[] = LOG_DEBUG_PREFIX(full_adapt_anc) "[Full Adapt ANC]process, on_schedule(%d), out_of_schedule(%d), Lib_state(%d), over(%d), status[%d][%d], peo(%d)(%d) sleep(0x%x)";
...
ATTR_LOG_STRING_LIB  g_FA_ANC_msg_id_string_7[] = LOG_DEBUG_PREFIX(full_adapt_anc) "[Rdbeug]FF_dump i(%d), %d, %d, %d, %d, %d, %d, %d, %d, %d, %d";
ATTR_LOG_STRING_LIB  g_FA_ANC_msg_id_string_8[] = LOG_DEBUG_PREFIX(full_adapt_anc) "[Rdbeug]FF_OUT i(%d), %d, %d, %d, %d, %d, %d, %d, %d, %d, %d";
ATTR_LOG_STRING_LIB  g_FA_ANC_msg_id_string_9[] = LOG_DEBUG_PREFIX(full_adapt_anc) "[Rdbeug]FB_dump i(%d), %d, %d, %d, %d, %d, %d, %d, %d, %d, %d";
ATTR_LOG_STRING_LIB  g_FA_ANC_msg_id_string_10[] = LOG_DEBUG_PREFIX(full_adapt_anc) "[Rdbeug]FB_MIC_IN i(%d), %d, %d, %d, %d, %d, %d, %d, %d, %d, %d";
ATTR_LOG_STRING_LIB  g_FA_ANC_msg_id_string_11[] = LOG_DEBUG_PREFIX(full_adapt_anc) "[Rdbeug]FB_OUT i(%d), %d, %d, %d, %d, %d, %d, %d, %d, %d, %d";
ATTR_LOG_STRING_LIB  g_FA_ANC_msg_id_string_12[] = LOG_DEBUG_PREFIX(full_adapt_anc) "[Rdbeug]300-tap dump 4 index(%d): 0x%x, 0x%x, 0x%x, 0x%x";
ATTR_LOG_STRING_LIB  g_FA_ANC_msg_id_string_13[] = LOG_DEBUG_PREFIX(full_adapt_anc) "[Rdbeug](%d)300-tap full dump index(%d): %d, %d, %d, %d";
ATTR_LOG_STRING_LIB  g_FA_ANC_msg_id_string_14[] = LOG_DEBUG_PREFIX(full_adapt_anc) "[Rdbeug]REF_dump i(%d), %d, %d, %d, %d, %d, %d, %d, %d, %d, %d";
ATTR_LOG_STRING_LIB  g_FA_ANC_msg_id_string_15[] = LOG_DEBUG_PREFIX(full_adapt_anc) "[Rdbeug]D_dump i(%d), %d, %d, %d, %d, %d, %d, %d, %d, %d, %d";
...
ATTR_LOG_STRING_LIB  g_FA_ANC_msg_id_string_61[] = LOG_DEBUG_PREFIX(full_adapt_anc) "[Rdbeug]g_FIR_FILTER b00(0x%x), shift_b(%d)";
