...
#ifndef _STREAM_CM4_VP_PLAYBACK_H_
#define _STREAM_CM4_VP_PLAYBACK_H_
...
typedef struct {
    ...
    U32 frame_size;
} cm4_vp_playback_pcm_ctrl_blk_t;
EXTERN VOID SourceInit_CM4_vp_playback(SOURCE source);

#endif /* MTK_PROMPT_SOUND_ENABLE */
#endif /* _STREAM_CM4_VP_PLAYBACK_H_ */
