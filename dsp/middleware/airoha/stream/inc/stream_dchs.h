...
#define DCHS_DL_PLAY_EN_DELAY_MS        (65)  //ms [hard code]
#define DCHS_DL_HFP_DELAY_TIME          (7.5*4) //ms
...
typedef enum{
    DCHS_DL_MIX_TYPE_NONE,
    UART_SCEANRIO_WAITING_MIX,
    LOCAL_SCEANRIO_WAITING_MIX,
}dchs_dl_mix_type_t;
