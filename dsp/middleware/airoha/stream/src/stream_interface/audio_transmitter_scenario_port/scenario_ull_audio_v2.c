...
ATTR_RWDATA_IN_DRAM static uint32_t crc32_tab[] = {
...
ATTR_TEXT_IN_IRAM static void ShareBufferCopy_I_24bit_to_D_16bit_2ch(uint8_t* src_buf, uint16_t* dest_buf1, uint16_t* dest_buf2, uint32_t samples)
{
    uint32_t data0;
    uint32_t data1;
    uint32_t data2;
...
ATTR_TEXT_IN_IRAM static void ShareBufferCopy_I_16bit_to_D_16bit_8ch(uint32_t* src_buf, uint16_t* dest_buf1, uint16_t* dest_buf2, uint16_t* dest_buf3, uint16_t* dest_buf4, uint16_t* dest_buf5, uint16_t* dest_buf6, uint16_t* dest_buf7, uint16_t* dest_buf8, uint32_t samples)
{
    uint32_t data0;
    uint32_t data1;
    uint32_t data2;
...
ATTR_TEXT_IN_IRAM static void ShareBufferCopy_I_24bit_to_D_16bit_8ch(uint32_t* src_buf, uint16_t* dest_buf1, uint16_t* dest_buf2, uint16_t* dest_buf3, uint16_t* dest_buf4, uint16_t* dest_buf5, uint16_t* dest_buf6, uint16_t* dest_buf7, uint16_t* dest_buf8, uint32_t samples)
{
    uint32_t data0;
    uint32_t data1;
    uint32_t data2;
...
static void ShareBufferCopy_D_16bit_to_D_32bit_1ch(uint16_t* src_buf, uint32_t* dest_buf, uint32_t samples)
{
    uint32_t data;
    uint32_t i;
                    ...
                    if (runtime->irq_exist == false) {
                        ...
                        if ((source->scenario_type == AUDIO_SCENARIO_TYPE_ULL_AUDIO_V2_DONGLE_DL_I2S_MST_IN_0) ||
                            ...
                            if ((buffer_info->WriteOffset & (~15)) == (buffer_info->ReadOffset & (~15))) {
                                ULL_V2_LOG_E("[ULL Audio V2][DL][AFE IN] hwsrc start full owo[%d] oro[%d]", buffer_info->WriteOffset, buffer_info->ReadOffset);
                            }
                        }
                    } else {
            ...
            for (j = 0; j < ULL_AUDIO_V2_DATA_CHANNEL_NUMBER; j++)
            {
                if (hal_memview_cm4_to_dsp0((uint32_t)(bt_common_open_param->scenario_param.ull_audio_v2_dongle_param.bt_link_info[i].share_info)) == (uint32_t)(ull_audio_v2_dl_bt_info[j].bt_link_info.share_info))
                {
                    ...
                    if (memcmp(&(bt_common_open_param->scenario_param.ull_audio_v2_dongle_param.bt_link_info[i].codec_type), &(ull_audio_v2_dl_bt_info[j].bt_link_info.codec_type), sizeof(ull_audio_v2_dongle_bt_link_info_t)-sizeof(void *)) != 0)
                    {
                        ...
                        ULL_V2_LOG_E("[ULL Audio V2][DL][ERROR]codec setting is different\r\n", 0);
                        AUDIO_ASSERT(0);
                    }
...
static void ull_audio_v2_dongle_dl_usb_in_init(ull_audio_v2_dongle_dl_handle_t *dongle_handle, audio_transmitter_open_param_p audio_transmitter_open_param, bt_common_open_param_p bt_common_open_param)
{
    ...
    sw_src_config.channel_number            = dongle_handle->source_info.usb_in.channel_num;
    ...
    ULL_V2_LOG_I("[ULL Audio V2][DL][scenario %d-%d][handle 0x%x]sw src 0x%x info, %d, %d, %d, %d, %d, %d, %d, %d, %d, %d, %d\r\n", 15,
                audio_transmitter_open_param->scenario_type,
                audio_transmitter_open_param->scenario_sub_id,
                dongle_handle,
                        ...
                        for (k = 0; k < ULL_AUDIO_V2_DATA_CHANNEL_NUMBER; k++)
                        {
                            if (c_handle->sink_info.bt_out.bt_info[k] != NULL)
                            {
                                if (dongle_handle->sink_info.bt_out.bt_info[j] == c_handle->sink_info.bt_out.bt_info[k])
                                {
                                    ...
                                    hal_nvic_restore_interrupt_mask(saved_mask);
                                    ULL_V2_LOG_I("[ULL Audio V2][DL][scenario %d-%d][handle 0x%x]sw mixer member 0x%x ch%d connect to [handle 0x%x]sw mixer member 0x%x ch%d\r\n", 8,
                                                audio_transmitter_open_param->scenario_type,
                                                audio_transmitter_open_param->scenario_sub_id,
                                                dongle_handle,
    ...
    ULL_V2_LOG_I("[ULL Audio V2][DL][scenario %d-%d][handle 0x%x]sw mixer 0x%x info, %d, %d, %d, %d, %d, %d, %d\r\n", 11,
                audio_transmitter_open_param->scenario_type,
                audio_transmitter_open_param->scenario_sub_id,
                dongle_handle,
                dongle_handle->mixer_member,
    ...
    if (dongle_handle->sink_info.bt_out.codec_type == AUDIO_DSP_CODEC_TYPE_LC3PLUS)
    {
        ...
        ULL_V2_LOG_I("[ULL Audio V2][DL][scenario %d-%d][handle 0x%x]lc3plus info, %d, %d, %d, %d, %d, %d, %d, %d, %d\r\n", 12,
                    audio_transmitter_open_param->scenario_type,
                    audio_transmitter_open_param->scenario_sub_id,
                    dongle_handle,
...
static void ull_audio_v2_dongle_dl_software_timer_start(ull_audio_v2_dongle_dl_handle_t *handle)
{
    uint32_t saved_mask;
    uint32_t gpt_time_us;
...
static void ull_audio_v2_dongle_dl_software_timer_stop(ull_audio_v2_dongle_dl_handle_t *handle)
{
    uint32_t saved_mask;
    bool do_timer_operation = false;
    UNUSED(handle);
...
void ull_audio_v2_dongle_ul_mixer_precallback(sw_mixer_member_t *member, void *para)
{
    uint32_t saved_mask;
    SOURCE source;
...
void ull_audio_v2_dongle_ul_mixer_all_stream_connections_update(ull_audio_v2_dongle_ul_handle_t *dongle_handle, bool new_stream, uint32_t mixer_connection_status)
{
    int16_t i,j;
    ull_audio_v2_dongle_ul_handle_t *c_handle;
    uint32_t saved_mask;
...
static void ull_audio_v2_dongle_ul_software_timer_start(ull_audio_v2_dongle_ul_handle_t *dongle_handle)
{
    uint32_t saved_mask;
...
static void ull_audio_v2_dongle_ul_software_timer_stop(ull_audio_v2_dongle_ul_handle_t *dongle_handle)
{
    uint32_t saved_mask;
    UNUSED(dongle_handle);
...
static void ull_audio_v2_dongle_ul_line_out_stop(ull_audio_v2_dongle_ul_handle_t *dongle_handle)
{
    uint32_t gpt_count;
    uint32_t saved_mask;
...
static void ull_audio_v2_dongle_ul_i2s_slv_out_start(ull_audio_v2_dongle_ul_handle_t *dongle_handle)
{
    ...
    dongle_handle->sink->streamBuffer.BufferInfo.WriteOffset = sample_size*dongle_handle->sink_info.i2s_slv_out.channel_num*((UL_I2S_SLV_PREFILL_SAMPLES_FRAME+UL_PROCESS_TIME_FRAME)*dongle_handle->sink_info.i2s_slv_out.sample_rate/1000);
    dongle_handle->sink->streamBuffer.BufferInfo.ReadOffset  = 0;
...
static void ull_audio_v2_dongle_ul_i2s_slv_out_stop(ull_audio_v2_dongle_ul_handle_t *dongle_handle)
{
    uint32_t gpt_count;
    uint32_t saved_mask;
    ...
    ULL_V2_LOG_I("[ULL Audio V2][UL][handle 0x%x][scenario %d-%d]i2s_slv-out stream start, gpt count = 0x%x", 4,
                dongle_handle,
                dongle_handle->source->param.bt_common.scenario_type,
                dongle_handle->source->param.bt_common.scenario_sub_id,
                gpt_count);
        ...
        if (c_sink->transform != NULL)
        {
            ...
            if ((c_sink->scenario_type == AUDIO_SCENARIO_TYPE_ULL_AUDIO_V2_DONGLE_DL_USB_IN_0) ||
                ...
                for (j = 0; j < c_handle->process_frames; j++) {
                    ...
                    LOG_AUDIO_DUMP((uint8_t *)address, c_sink->transform->source->streamBuffer.ShareBufferInfo.sub_info.block_info.block_size - sizeof(audio_transmitter_frame_header_t), SOURCE_IN2 + (c_handle->sub_id - AUDIO_TRANSMITTER_ULL_AUDIO_V2_DONGLE_DL_USB_IN_0));
                }
            }
            #endif /* ULL_AUDIO_V2_DONGLE_DL_PATH_DEBUG_DUMP */
            #endif /* AIR_AUDIO_DUMP_ENABLE */
            ...
            if (silence_detection_handle->enable)
            {
                ...
                silence_detection_handle->data_size = c_handle->sink_info.bt_out.frame_samples * sizeof(int32_t);
                if (c_handle->process_frames != 0)
                {
                    ...
                    {
                        ShareBufferCopy_D_16bit_to_D_32bit_1ch((uint16_t* )data_buf_1_head, (uint32_t* )(silence_detection_handle->data_buf), c_handle->sink_info.bt_out.frame_samples);
                    }
                    else
                    {
                        memcpy(silence_detection_handle->data_buf, data_buf_1_head, silence_detection_handle->data_size);
                    }
                }
                else
                {
...
//#ifdef AIR_ECNR_POST_PART_ENABLE
                        ...
                        if (actual_PduLen != dongle_handle->source_info.bt_in.frame_size) {
                            ULL_V2_LOG_E("[ULL Audio V2][UL][ERROR][handle 0x%x] frame_size is not right %d, %d", 3,
                                            dongle_handle,
                                            actual_PduLen,
                                            dongle_handle->source_info.bt_in.frame_size);
                            AUDIO_ASSERT(0);
...
void ull_audio_v2_dongle_ul_source_drop_postprocess(SOURCE source, uint32_t amount)
{
    ...
    else if (dongle_handle->sub_id == AUDIO_TRANSMITTER_ULL_AUDIO_V2_DONGLE_UL_I2S_SLV_OUT_0)
    {
        ...
        ULL_V2_LOG_I("[ULL Audio V2][UL][handle 0x%x][source_drop_postprocess] i2ss-out %d, %d, %d, %d, %d, 0x%x, 0x%x, 0x%x, %d, %d, 0x%x, 0x%x, 0x%x, 0x%x, 0x%x, 0x%x", 17,
                        dongle_handle,
                        dongle_handle->stream_status,
                        dongle_handle->first_packet_status,
                        dongle_handle->data_status,
                        ...
                        dongle_handle->clk_skew_count,
                        dongle_handle->compen_samples,
                        dongle_handle->sink_info.i2s_slv_out.cur_write_offset,
                        dongle_handle->sink_info.i2s_slv_out.cur_read_offset,
...
void ull_audio_v2_dongle_dl_init_afe_in(ull_audio_v2_dongle_dl_handle_t *dongle_handle, audio_transmitter_open_param_p audio_transmitter_open_param, bt_common_open_param_p bt_common_open_param)
{
    ...
    dongle_handle->src_in_frame_size        = dongle_handle->src_in_frame_samples * sizeof(int32_t);
                        ...
                        for (k = 0; k < ULL_AUDIO_V2_DATA_CHANNEL_NUMBER; k++)
                        {
                            if (c_handle->sink_info.bt_out.bt_info[k] != NULL)
                            {
                                if (dongle_handle->sink_info.bt_out.bt_info[j] == c_handle->sink_info.bt_out.bt_info[k])
                                {
                                    ...
                                    dongle_handle->mixer_status = ULL_AUDIO_V2_DONGLE_MIXER_MIX;
                                    hal_nvic_restore_interrupt_mask(saved_mask);
                                    ULL_V2_LOG_I("[ULL Audio V2][DL][scenario type %d-%d][handle 0x%x]sw mixer member 0x%x ch%d connect to [handle 0x%x]sw mixer member 0x%x ch%d\r\n", 8,
                                                dongle_handle->source->scenario_type,
                                                dongle_handle->sink->scenario_type,
                                                dongle_handle,
                                                dongle_handle->mixer_member,
...
void ull_audio_v2_dongle_silence_detection_process(audio_scenario_type_t scenario)
{
    ...
    {
        port = silence_detection_handle->port;
        for (frame_num = 0; frame_num < (silence_detection_handle->data_size/silence_detection_handle->frame_size); frame_num++)
        {
            /* get the latest volume of each 2.5ms frame and the current_db will be updated */
            if (volume_estimator_process(port, (void *)((uint8_t *)(silence_detection_handle->data_buf)+silence_detection_handle->frame_size*frame_num), silence_detection_handle->frame_size, &silence_detection_handle->current_db) != VOLUME_ESTIMATOR_STATUS_OK)
            {
                AUDIO_ASSERT(0);
            }
            // DSP_MW_LOG_I("[ULL Audio V2][DL][silence_detection][volume]:%d\r\n", 1, silence_detection_handle->current_db);
            ...
            if (silence_detection_handle->current_db <= silence_detection_handle->effective_threshold_db)
            {
                ...
                if (silence_detection_handle->effective_delay_us_count >= silence_detection_handle->effective_delay_ms*1000)
                {
                    if (silence_detection_handle->status != ULL_AUDIO_V2_DONGLE_SILENCE_DETECTION_STATUS_SILENCE)
                    {
                        ...
                        DSP_MW_LOG_I("[ULL Audio V2][DL][silence_detection][send msg]:%d, %d, %d, %d, %d, %d\r\n", 6,
