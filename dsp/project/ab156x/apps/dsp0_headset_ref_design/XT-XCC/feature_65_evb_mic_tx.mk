...
# This option is to enable/disable Hybrid Passthru.
# It must be turned on/off for both DSP and MCU, otherwise, it will not work.
# Dependency: AIR_ANC_ENABLE must be enabled when this option is set to y.
...
# It must be turned on/off for both DSP and MCU, otherwise, it will not work.
AIR_BT_A2DP_AAC_ENABLE = n

# This option is used to enable SBC codec.
# It must be turned on/off for both DSP and MCU, otherwise, it will not work.
AIR_BT_A2DP_SBC_ENABLE = n
...
# This option is to enable advanced record scenario.
# Dependency: AIR_RECORD_ADVANCED_ENABLE must be enabled when this option is set to y.
# It must be turned on/off for both DSP and MCU, otherwise, it will not work.
...
AIR_DSP_LINKER_SCRIPT_FILE = ab156x_dsp0_flash_mic_tx.lcf
...
## Notice:      None.
##
AIR_DSP_PRODUCT_CATEGORY = Headset
