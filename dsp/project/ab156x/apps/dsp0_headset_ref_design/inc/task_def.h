...
#define FREERTOS_EXAMPLE_TASK_STACKSIZE  (configMINIMAL_STACK_SIZE * sizeof(StackType_t) + 1024) //byte
#define FREERTOS_EXAMPLE_TASK_PRIO       TASK_PRIORITY_LOW

#define AUDIO_EXAMPLE_TASK_NAME          "audio"
#define AUDIO_EXAMPLE_TASK_STACKSIZE     (configMINIMAL_STACK_SIZE * sizeof(StackType_t) + 1024) //byte
#define AUDIO_EXAMPLE_TASK_PRIO          TASK_PRIORITY_NORMAL
