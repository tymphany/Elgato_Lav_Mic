...
typedef struct
{
  ...
  __IOM uint32_t NSACR;                  /*!< Offset: 0x08C (R/W)  Non-Secure Access Control Register */
        uint32_t RESERVED3[21U];
        uint32_t SFSR;                   /*!< Offset: 0x0E4 (R/W)  Secure Fault Status Register*/
        uint32_t SFAR;                   /*!< Offset: 0x0E8 (R/W)  Secure Fault Address Register*/
        uint32_t RESERVED4[69U];
