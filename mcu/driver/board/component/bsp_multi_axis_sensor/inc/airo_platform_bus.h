...
#if 1
#define log_sensor_bus_info(_message, cnt, ...)      //log_hal_msgid_info(_message,cnt,    ##__VA_ARGS__)
#define log_sensor_bus_warn(_message, cnt, ...)      log_hal_msgid_warning(_message,cnt, ##__VA_ARGS__)
#define log_sensor_bus_error(_message,cnt, ...)      log_hal_msgid_error(_message,cnt,   ##__VA_ARGS__)
#else
