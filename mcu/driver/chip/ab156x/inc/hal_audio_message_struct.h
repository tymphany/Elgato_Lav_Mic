...
typedef enum {
    ...
    AUDIO_TRANSMITTER_SHARE_INFO_INDEX_WIRELESS_MIC_RX_BT_RECEIVE_FROM_AIR_0,  //Share buffer
    AUDIO_TRANSMITTER_SHARE_INFO_INDEX_WIRELESS_MIC_RX_BT_RECEIVE_FROM_AIR_1,
    AUDIO_TRANSMITTER_SHARE_INFO_INDEX_WIRELESS_MIC_RX_BT_RECEIVE_FROM_AIR_2,
    AUDIO_TRANSMITTER_SHARE_INFO_INDEX_WIRELESS_MIC_RX_BT_RECEIVE_FROM_AIR_3,
    AUDIO_TRANSMITTER_SHARE_INFO_INDEX_WIRELESS_MIC_RX_DSP_SEND_TO_MCU_0,
    AUDIO_TRANSMITTER_SHARE_INFO_INDEX_ADVANCED_RECORD_N_MIC,
...
#define SHARE_BUFFER_RINGTONE_SIZE         (16)
...
#if defined(AIR_ECNR_1MIC_INEAR_ENABLE) || defined(AIR_ECNR_2MIC_INEAR_ENABLE) || defined(AIR_3RD_PARTY_NR_ENABLE) || defined(AIR_BT_ULTRA_LOW_LATENCY_ENABLE) || defined(AIR_BLE_AUDIO_DONGLE_ENABLE)
...
#define SHARE_BUFFER_BT_AUDIO_USB_IN_SIZE   (4640) /* Support 96K/24bit/2ch/8ms(5ms+3ms) */
//#define SHARE_BUFFER_BT_AUDIO_USB_OUT_SIZE   (8660) /* Support 48K/24bit/2ch/15ms/2-process */
#endif
...
#endif
#if defined (AIR_ULL_AUDIO_V2_DONGLE_ENABLE) || defined (AIR_BLE_AUDIO_DONGLE_ENABLE) || defined(AIR_WIRELESS_MIC_RX_ENABLE)
#define SHARE_BUFFER_USB_SIZE               (20*1024)
#endif /* AIR_ULL_AUDIO_V2_DONGLE_ENABLE || AIR_BLE_AUDIO_DONGLE_ENABLE */
...
#endif /* AIR_ULL_AUDIO_V2_DONGLE_ENABLE || AIR_BLE_AUDIO_DONGLE_ENABLE || AIR_WIRELESS_MIC_RX_ENABLE */
