...
#define AESOTF_KEY_SOURCE_EFUSE_0      (0)
#define AESOTF_KEY_SOURCE_EFUSE_1      (1)
#define AESOTF_KEY_SOURCE_SW           (2)
#define AESOTF_KEY_SOURCE_HW_CKDF_0    (3)
#define AESOTF_KEY_SOURCE_HW_CKDF_1    (4)
#define AESOTF_KEY_SOURCE_NUM          (5)

#define AESOTF_REGION_0     (0)
#define AESOTF_REGION_1     (1)
#define AESOTF_REGION_2     (2)
#define AESOTF_REGION_3     (3)
#define AESOTF_REGION_4     (4)
#define AESOTF_REGION_5     (5)
#define AESOTF_REGION_6     (6)
#define AESOTF_REGION_7     (7)
#define AESOTF_REGION_ALL   (8)
#define AESOTF_REGION_INIT  (9)
