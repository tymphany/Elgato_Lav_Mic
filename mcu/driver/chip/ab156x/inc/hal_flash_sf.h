...
typedef enum {
    SF_ISSI_EXTEND_REG_PFAIL        = 0x04
    , SF_ISSI_EXTEND_REG_EFAIL       = 0x08
} SF_ISSI_Security_Indication_Enum;
...
// Serial Flash commands (ISSI specific)
#define SF_CMD_ISSI_QPIEN                   (0x35)
#define SF_CMD_ISSI_RSTQPI                  (0xF5)
#define SF_CMD_ISSI_READ_FUNC_SR            (0x48)  // OTP Read status
#define SF_CMD_ISSI_WRITE_FUNC_SR           (0x42)  // OTP write status
#define SF_CMD_ISSI_READ_EXTEND_SR          (0x81)  // OTP Read status
#define SF_CMD_ISSI_SET_BURST_LENGTH        (0xC0)
#define SF_CMD_ISSI_BURST_LENGTH_32_BYTE    (0x02)
#define SF_CMD_ISSI_BURST_LENGTH_DISABLE    (0x10)
#define SF_CMD_ISSI_FAST_READ_WRAP          (0x0B)  // for direct mode usage
#define SF_CMD_ISSI_FAST_READ_ENH           (0xEB)  // for direct mode usage
#define SF_CMD_ISSI_READ_INFO_ROW           (0x68)    // SST: Read OTP registers
#define SF_CMD_ISSI_PROG_INFO_ROW           (0x62)    // SST: Program OTP registers
#define SF_CMD_ISSI_ERASE_INFO_ROW          (0x64)    // SST: Lock OTP registers
...
#define SF_GIGADEVICE_SSR_OTP               (0x38)        //Security register lock bits (LB0, LB1, LB2, LB3)

#define SF_OTP_BANK_SIZE                    (0X100)
...
#define SF_WINBOND_PROTECT_TOP_128KB_W25Q64JW  (0x24)

/*  TIME_CHECK_DISABLE_IRQ_TIME is 70us, set less than TIME_CHECK_DISABLE_IRQ_TIME  */
#define SF_DAL_MXIC_TERS                     (30)
#define SF_DAL_WINBOND_TERS                  (30)
#define SF_DAL_GIGADEVICE_TERS               (30)
#define SF_DAL_ISSI_TERS                     (30)
#define SF_DAL_DEFAULT_TERS                  (30)
