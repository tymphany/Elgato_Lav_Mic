...
#define AFE_VOW_TOP_CON1                                    (0xA4000004)
#define AFE_VOW_TOP_CON2                                    (0xA4000008)
...
typedef enum {
    ...
    /* power */
    AUDIO_POWER_MICBIAS_0  = 14,                               /**< Audio Power for Micbias 1 */
    AUDIO_POWER_MICBIAS_1  = 15,                               /**< Audio Power for Micbias 2 */
    AUDIO_POWER_MICBIAS_2  = 16,                               /**< Audio Power for Micbias 3 */
    AUDIO_POWER_MICBIAS_END = AUDIO_POWER_MICBIAS_2,           /**< Audio Power for Micbias End */
    AUDIO_POWER_DAC        = 17,                               /**< Audio Power for DAC Out(vitual), for amp lock */
    AUDIO_POWER_I2S        = 18,                               /**< Audio Power for I2S MST Out(vitual), for amp lock */
    /* SPM STATE */
    AUDIO_DSP_SPM_STATE1   = 19,                               /**< Audio DSP Low power state1, dsp can't sleep */
    AUDIO_DSP_SPM_STATE3   = 20,                               /**< Audio DSP Low power state3, audio won't use, reserved */
    AUDIO_DSP_SPM_STATE4   = 21,                               /**< Audio DSP Low power state4, dsp can sleep */
    AUDIO_POWER_END        = 22,                               /**< Audio Power End Number*/
...
typedef enum {
    ...
    AUDIO_DSP_CHANNEL_SELECTION_ONLY_L          = 9, /**< DSP streaming output only L. */
    AUDIO_DSP_CHANNEL_SELECTION_ONLY_R          = 10, /**< DSP streaming output only R. */
...
typedef enum {
    ...
    /* special CG control */
    HAL_CLOCK_CG_PWM_MULTI_CTRL            = (0 + 1024)
} hal_clock_cg_id;
...
typedef enum {
    ...
    HAL_DVFS_MAX_SPEED,
    HAL_DVFS_CURR_SPEED /* special parameter for locking current DVFS OPP */
} dvfs_frequency_t;
#endif
/**
  * @}
