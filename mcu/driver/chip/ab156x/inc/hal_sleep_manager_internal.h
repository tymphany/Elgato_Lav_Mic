...
#define  SLEEP_LOCK_HANDLE_MAX          64
#define  SLEEP_LOCK_HANDLE_USER_MAX     (((SLEEP_LOCK_HANDLE_MAX-SLEEP_LOCK_USER_START_ID) > (32)) ? (32) : (SLEEP_LOCK_HANDLE_MAX-SLEEP_LOCK_USER_START_ID))
