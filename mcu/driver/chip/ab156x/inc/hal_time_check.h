...
#define TIME_CHECK_ISR_TIME   5000              //Set the ISR execution time 500us limit
...
#define TIME_CHECK_DISABLE_IRQ_TIME_SPECIAL   5000        //Set the IRQ disable time 5000us limit,only used for DVFS & PMU.
