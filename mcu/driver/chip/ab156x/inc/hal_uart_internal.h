...
/*internal API for uart to query tx/rx is empty*/
bool uart_query_rx_empty(hal_uart_port_t uart_port);    // return true means empty.
bool uart_query_tx_empty(hal_uart_port_t uart_port);    // return true means empty.
