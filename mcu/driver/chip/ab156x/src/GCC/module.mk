...
ifeq ($(AIR_BTA_PMIC_G2_LP),y)
C_FILES  += $(DRIVER_CHIP)/src/hal_pmu_internal_2565.c
C_FILES  += $(DRIVER_CHIP)/src/hal_pmu_cali_2565.c
C_FILES  += $(DRIVER_CHIP)/src/hal_pmu_charger_2565.c
C_FILES  += $(DRIVER_CHIP)/src/hal_pmu_auxadc_2565.c
else ifeq ($(AIR_BTA_PMIC_G2_HP),y)
C_FILES  += $(DRIVER_CHIP)/src/hal_pmu_internal_2568.c
C_FILES  += $(DRIVER_CHIP)/src/hal_pmu_charger_2568.c
C_FILES  += $(DRIVER_CHIP)/src/hal_pmu_auxadc_2568.c
endif
