...
ATTR_ZIDATA_IN_TCM MPU_CTRL_Type g_mpu_ctrl;
ATTR_ZIDATA_IN_TCM MPU_REGION_EN_Type g_mpu_region_en;
ATTR_ZIDATA_IN_TCM MPU_ENTRY_Type g_mpu_entry[HAL_MPU_REGION_MAX];
