...
hal_spi_slave_status_t hal_spi_slave_init(hal_spi_slave_port_t spi_port, hal_spi_slave_config_t *spi_configure)
{
    ...
    sleep_management_register_suspend_callback(SLEEP_BACKUP_RESTORE_SPI_SLV, (sleep_management_suspend_callback_t)spi_slave_backup_register_callback, NULL);
    sleep_management_register_resume_callback(SLEEP_BACKUP_RESTORE_SPI_SLV, (sleep_management_resume_callback_t)spi_slave_restore_register_callback, NULL);
#endif
