...
DRIVER_CORE = driver/chip/$(IC_CONFIG)/src_core

CFLAGS   += $(FPUFLAGS) -DUSE_HAL_DRIVER 

C_FILES  += $(DRIVER_CORE)/dummy.c          
C_FILES  += $(DRIVER_CORE)/hal_sleep_manager_internal.c  
C_FILES  += $(DRIVER_CORE)/hal_sleep_manager.c       
C_FILES  += $(DRIVER_CORE)/hal_spm.c
