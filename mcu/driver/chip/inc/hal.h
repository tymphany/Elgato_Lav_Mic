 ...
 *
 * - \b Introduction \n
 *   Airoha IoT SDK hardware abstraction layer (HAL) driver is embedded software ensuring maximized portability across IoT portfolio designed for Airoha IoT SDK development platform.\n
