...
/** @brief This enum defines the ADC API average times*/
typedef enum {
    HAL_ADC_AVERAGE_1 =   0,                            /**< Average number 1 */
    HAL_ADC_AVERAGE_4 =   1,                            /**< Average number 4 */
    HAL_ADC_AVERAGE_8 =   2,                            /**< Average number 8 */
    HAL_ADC_AVERAGE_16 =  3,                            /**< Average number 16 */
    HAL_ADC_AVERAGE_32 =  4,                            /**< Average number 32 */
    HAL_ADC_AVERAGE_64 =  5,                            /**< Average number 64 */
    HAL_ADC_AVERAGE_128 = 6,                            /**< Average number 128 */
    HAL_ADC_AVERAGE_256 = 7,                            /**< Average number 256 */
 ...
 * @brief       ADC receives a sample data for a channel.
 * @param[in] channel is the channel that will be sampled. This parameter can only be the value of type #hal_adc_channel_t.
 * @param[in] average_num is the sample average number.This parameter can only be the value of type #hal_adc_average_t.
 * @param[out] data is the raw data of the channel.
 * @return
 * #HAL_ADC_STATUS_OK, ADC get data success. \n
 * #HAL_ADC_STATUS_ERROR_CHANNEL, the channel number is invalid. \n
...
/**
 * @brief       ADC receives a calibration data for a channel.
 * @param[in] raw_data is the raw data of the channel.
 * @param[out] cal_data is the calibration data of the channel.
 * @return
 * #HAL_ADC_STATUS_OK, ADC get data success. \n
 * #HAL_ADC_STATUS_INVALID_PARAMETER, cal_data is NULL.
 * @par Example
 * Sample code please refer to Use ADC driver to get sample data for a channel of @ref HAL_ADC_Driver_Usage_Chapter
 */
...
/**
 * @brief       ADC receives a calibration voltage for a channel.
 * @param[in] raw_data is the raw data of the channel.
 * @param[out] cal_voltage is the calibration voltage of the channel.
 * @return
 * #HAL_ADC_STATUS_OK, ADC get cal_voltage success. \n
 * #HAL_ADC_STATUS_INVALID_PARAMETER, cal_data is NULL.
 * @par Example
 * Sample code please refer to Use ADC driver to get sample data for a channel of @ref HAL_ADC_Driver_Usage_Chapter
 */
