 ...
 *
 *	hal_cache_set_size(HAL_CACHE_SIZE_16K); // Set the total CACHE size.
 *
...
/**
 * @brief  This function converts a cacheable address to a non-cacheable address.
...
/**
 * @brief  This function converts a non-cacheable address to a cacheable address.
...
#endif /* HAL_CACHE_ATTRIBUTE_CONVERT */
