 ...
 *  - Step 1. Call #hal_sdio_init() to initialize the MSDC and the SDIO slave to transfer states.
 *  - Step 2. Call #hal_sdio_set_clock() to set the SDIO output clock.
 *      @code
 *        hal_sdio_status_t ret;
 *        hal_sdio_config_t sdio_config = {HAL_SDIO_BUS_WIDTH_4, 25000};
 *        ret = hal_sdio_init(HAL_SDIO_PORT_0,&sdio_config);
 ...
 *  - Step 1. Call #hal_sdio_init() to initialize the MSDC and the SDIO slave to transfer states.
 *  - Step 2. Call #hal_sdio_get_clock() to get the SDIO output clock.
 *      @code
 *        hal_sdio_status_t ret;
 *        uint32_t clock = 0;
 *        hal_sdio_config_t sdio_config = {HAL_SDIO_BUS_WIDTH_4, 25000};
 ...
 *  - Step 1. Call #hal_sdio_init() to initialize the MSDC and the SDIO slave to transfer states.
 *  - Step 2. Call #hal_sdio_set_bus_width() to set the SDIO bus width.
 *      @code
 *         hal_sdio_status_t ret;
 *         hal_sdio_config_t sdio_config = {HAL_SDIO_BUS_WIDTH_4, 25000};
 *         ret = hal_sdio_init(HAL_SDIO_PORT_0,&sdio_config);
 ...
 *  - Step 1. Call #hal_sdio_init() to initialize the MSDC and the SDIO slave to transfer states.
 *  - Step 2. Call #hal_sdio_set_block_size() to set the SDIO block size.
 *      @code
 *         hal_sdio_status_t ret;
 *         hal_sdio_config_t sdio_config = {HAL_SDIO_BUS_WIDTH_4, 25000};
 *         ret = hal_sdio_init(HAL_SDIO_PORT_0,&sdio_config);
 ...
 *  - Step 1. Call #hal_sdio_init() to initialize the MSDC and the SDIO slave to transfer states.
 *  - Step 2. Call #hal_sdio_get_block_size() to get the SDIO block size.
 *      @code
 *         uint32_t block_size;
 *         hal_sdio_status_t ret;
 *         hal_sdio_config_t sdio_config = {HAL_SDIO_BUS_WIDTH_4, 25000};
 ...
 *          ret = hal_sdio_get_block_size(HAL_SDIO_PORT_0,HAL_SDIO_FUNCTION_1,&block_size);
 *          if (HAL_SDIO_STATUS_OK != ret) {
 *              // Error handler.
 *          }
 *    @endcode
