...
typedef enum {
    HAL_SHA_STATUS_BUSY  = -100,    /**< crypto hw is busy. */
...
#ifdef HAL_SHA_FEATURE_POLLING_ENABLED
/**
 * @brief  Switch SHA to polling mode.
 *
 */
void hal_sha_enable_polling_mode(void);
 ...
 *
 */
void hal_sha_disable_polling_mode(void);
#endif
