 ...
 * @addtogroup WDT
 * @{
 * This section introduces the Watchdog Timer (WDT) APIs including terms and acronyms,
...
typedef struct {
    ...
    uint32_t        seconds;    /**< Specify the watchdog timer timeout value in seconds. The minimum is 1 second and the maximum is #HAL_WDT_MAX_TIMEOUT_VALUE seconds.*/
} hal_wdt_config_t;
...
#ifdef HAL_WDT_FEATURE_SECOND_CHANNEL
