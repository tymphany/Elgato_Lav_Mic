 ...
 *  CCCI is CCNI upper layer. CCNI is based on HW of IRQGEN to implement a simpleness communication mechanism. Different chips may have different CCNI, so CCCI should be used according to the CCNI of the chips.
 ...
 *    Please reference the sample of dsp\project\xxx\templates\dsp0_freertos_create_thread\inc\ccci_configure.h and dsp\project\xxx\templates\dsp1_create_message_queue\inc\ccci_configure.h .
...
/** @brief define the DSP1 to DSP0 event list. */
#ifndef DSP1_TO_DSP0_CCCI_EVENT_LIST
#define DSP1_TO_DSP0_CCCI_EVENT_LIST
#endif
/** @brief define the DSP0 to DSP1 event list. */
#ifndef DSP0_TO_DSP1_CCCI_EVENT_LIST
#define DSP0_TO_DSP1_CCCI_EVENT_LIST
#endif
/** @brief define the CM4 to DSP0 event list. */
#ifndef CM4_TO_DSP0_CCCI_EVENT_LIST
#define CM4_TO_DSP0_CCCI_EVENT_LIST
#endif
/** @brief define the DSP0 to CM4 event list. */
#ifndef DSP0_TO_CM4_CCCI_EVENT_LIST
#define DSP0_TO_CM4_CCCI_EVENT_LIST
#endif
/** @brief define the CM4 to DSP1 event list. */
#ifndef CM4_TO_DSP1_CCCI_EVENT_LIST
#define CM4_TO_DSP1_CCCI_EVENT_LIST
#endif
/** @brief define the DSP1 to CM4 event list. */
#ifndef DSP1_TO_CM4_CCCI_EVENT_LIST
#define DSP1_TO_CM4_CCCI_EVENT_LIST
#endif
/** @brief define the DSP1 source index. */
#ifndef CCNI_EVENT_SRC_DSP1
#define CCNI_EVENT_SRC_DSP1    (0x3<<24)
#endif
/** @brief define the DSP1 destination index. */
#ifndef CCNI_EVENT_DST_DSP1
#define CCNI_EVENT_DST_DSP1    (0x3<<16)
#endif
 ...
 *   #include "ccci.h"
 *   ccci_msg_t ccci_msg;
 *   ccci_msg.event = CCCI_DSP0_TO_CM4_EVENT_XXX;
 *   ccci_msg.data = 0xabc;
 *   ccci_msg.data2 = 0x123;
 *   if(CCCI_STATUS_OK != ccci_send_msg(HAL_CORE_MCU,&ccci_msg,CCCI_SEND_MSG_NO_WAIT))
 *   {
 *       assert(0);
 *   }
 *  @endcode
