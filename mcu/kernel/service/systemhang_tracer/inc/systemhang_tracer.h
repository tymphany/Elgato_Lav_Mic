...
/* define ---------------------------------------------------------------------*/
#define SYSTEMHANG_USER_CONFIG_COUNT_TOTAL              (4)
...
/* functions ------------------------------------------------------------------*/
extern void systemhang_wdt_feed_in_task_switch(void);
extern void systemhang_set_safe_duration(uint32_t user_id, uint32_t safe_sec);
...
extern void systemhang_retention_status_get_tag(char *data, uint32_t length);
