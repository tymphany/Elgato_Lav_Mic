...
typedef enum {
    ...
    ATTDET_PARAMETER_INDEX_AUDIO_GAIN_INFORMATION_HEADSET = 0x10,
    ATTDET_PARAMETER_INDEX_AUDIO_GAIN_INFORMATION_HANDSFREE = 0x11,
    ATTDET_PARAMETER_INDEX_VOICE_GAIN_INFORAMTION_HEADSET = 0x12,
    ATTDET_PARAMETER_INDEX_VOICE_GAIN_INFORAMTION_HANDSFREE = 0x13,
    ATTDET_PARAMETER_INDEX_VOICE_GAIN_INFORAMTION_RESERVED = 0x14,
    ATTDET_PARAMETER_INDEX_RECORD_GAIN_INFORMATION_NORMAL = 0x15,
    ATTDET_PARAMETER_INDEX_RECORD_GAIN_INFORMATION_ASR = 0x16,
    ATTDET_PARAMETER_INDEX_RECORD_GAIN_INFORMATION_STEREO = 0x17,
    ATTDET_PARAMETER_INDEX_AUDIO_IIR_FILTER_INFORMATION = 0x20,
    ATTDET_PARAMETER_INDEX_VOICE_NB_MODE_AND_FIR_PARAMETER_INFORMATION = 0x21,
    ATTDET_PARAMETER_INDEX_VOICE_WB_MODE_AND_FIR_PARAMETER_INFORMATION = 0x22,
    ATTDET_PARAMETER_INDEX_RECORD_WB_MODE_AND_FIR_PARAMETERS_INFORMATION = 0x23,
    ...
    switch (atttest_nvdm_callback_useful_info_ptr->now_device_mode) {
        ...
        case ATTTEST_DEVICE_MODE_VOICE_NB_MODE_3:
...

            {
                ...
                if (atttest_nvdm_callback_useful_info_ptr->now_device_mode == ATTTEST_DEVICE_MODE_VOICE_NB_MODE_1 || atttest_nvdm_callback_useful_info_ptr->now_device_mode == ATTTEST_DEVICE_MODE_VOICE_NB_MODE_2) {
        ...
        case ATTTEST_DEVICE_MODE_VOICE_WB_MODE_3:
            ...
            {
                // update stream in volume
                if (atttest_nvdm_callback_useful_info_ptr->now_device_mode == ATTTEST_DEVICE_MODE_VOICE_WB_MODE_1 || atttest_nvdm_callback_useful_info_ptr->now_device_mode == ATTTEST_DEVICE_MODE_VOICE_WB_MODE_2) {
                    voice_uplink_amp_db_transfer_to_analog_gain_and_digital_gain(temp_stream_in_db, &temp_a_gain, &temp_d_gain);
                } else {    // ATTTEST_DEVICE_MODE_VOICE_NB_MODE_3
                    voice_uplink_dmic_db_transfer_to_analog_gain_and_digital_gain(temp_stream_in_db, &temp_a_gain, &temp_d_gain);
                }
    ...
    switch (AT_command_array[0]) {
        ...
        case ATTTEST_SCENARIO_VOICE:
            switch (AT_command_array[1]) {
                ...
                case ATTTEST_DEVICE_MODE_VOICE_NB_MODE_2:
                case ATTTEST_DEVICE_MODE_VOICE_NB_MODE_3:
                    LOGMSGIDI("atttest scenario:voice, device mode:%d, stream out level:%d\n", 2, (AT_command_array[1] - ATTTEST_DEVICE_MODE_VOICE_NB_MODE_1), AT_command_array[2]);
                    ...
                    if (AT_command_array[1] == ATTTEST_DEVICE_MODE_VOICE_NB_MODE_1) {
                        LOGMSGIDI("atttest: stream_out:HAL_AUDIO_DEVICE_HEADSET_MONO, stream_in:HAL_AUDIO_DEVICE_HEADSET_MIC, NB, chose_stream_out_level_in_db=%x, chose_side_tone_db=%x, chose_stream_in_db=%x\n", 3, chose_stream_out_level_in_db, chose_side_tone_db, chose_stream_in_db);
                        ...
                        LOGMSGIDI("atttest: stream_out:HAL_AUDIO_DEVICE_HANDS_FREE_MONO, stream_in:HAL_AUDIO_DEVICE_MAIN_MIC, NB, chose_stream_out_level_in_db=%x, chose_side_tone_db=%x, chose_stream_in_db=%x\n", 3, chose_stream_out_level_in_db, chose_side_tone_db, chose_stream_in_db);
                        ...
                        LOGMSGIDI("atttest: stream_out:HAL_AUDIO_DEVICE_HEADSET_MONO, stream_in:HAL_AUDIO_DEVICE_DUAL_DIGITAL_MIC, NB, chose_stream_out_level_in_db=%x, chose_side_tone_db=%x, chose_stream_in_db=%x\n", 3, chose_stream_out_level_in_db, chose_side_tone_db, chose_stream_in_db);
                        voice_play(HAL_AUDIO_DEVICE_HEADSET_MONO, HAL_AUDIO_DEVICE_DUAL_DIGITAL_MIC, NB, chose_stream_out_level_in_db, chose_side_tone_db, chose_stream_in_db);
                    }
                ...
                case ATTTEST_DEVICE_MODE_VOICE_WB_MODE_2:
                case ATTTEST_DEVICE_MODE_VOICE_WB_MODE_3:
                    LOGMSGIDI("atttest scenario:voice, device mode:%d, stream out level:%d\n", 2, (AT_command_array[1] - ATTTEST_DEVICE_MODE_VOICE_WB_MODE_1), AT_command_array[2]);
                    ...
                    if (AT_command_array[1] == ATTTEST_DEVICE_MODE_VOICE_WB_MODE_1) {
                        LOGMSGIDI("atttest: stream_out:HAL_AUDIO_DEVICE_HEADSET_MONO, stream_in:HAL_AUDIO_DEVICE_HEADSET_MIC, WB, chose_stream_out_level_in_db=%x, chose_side_tone_db=%x, chose_stream_in_db=%x\n", 3, chose_stream_out_level_in_db, chose_side_tone_db, chose_stream_in_db);
                    ...
                    } else if (ATTTEST_DEVICE_MODE_VOICE_WB_MODE_2) {
                        LOGMSGIDI("atttest: stream_out:HAL_AUDIO_DEVICE_HANDS_FREE_MONO, stream_in:HAL_AUDIO_DEVICE_MAIN_MIC, WB, chose_stream_out_level_in_db=%x, chose_side_tone_db=%x, chose_stream_in_db=%x\n", 3, chose_stream_out_level_in_db, chose_side_tone_db, chose_stream_in_db);
                    ...
                    } else {    // ATTTEST_DEVICE_MODE_VOICE_WB_MODE_3
                        LOGMSGIDI("atttest: stream_out:HAL_AUDIO_DEVICE_HEADSET_MONO, stream_in:HAL_AUDIO_DEVICE_DUAL_DIGITAL_MIC, WB, chose_stream_out_level_in_db=%x, chose_side_tone_db=%x, chose_stream_in_db=%x\n", 3, chose_stream_out_level_in_db, chose_side_tone_db, chose_stream_in_db);
                        voice_play(HAL_AUDIO_DEVICE_HEADSET_MONO, HAL_AUDIO_DEVICE_DUAL_DIGITAL_MIC, WB, chose_stream_out_level_in_db, chose_side_tone_db, chose_stream_in_db);
                    }
...
static attdet_error_check_t query_useful_information_for_ui_tool(uint32_t *out_data_buffer, int16_t *out_data_buffer_size, uint32_t at_command_array[], int16_t at_command_array_size)
{
    ...
    switch (at_command_array[3]) {
        ...
        case ATTDET_PARAMETER_INDEX_AUDIO_GAIN_INFORMATION_HEADSET:
            ...
            LOGMSGIDI("parameter index: ATTDET_PARAMETER_INDEX_AUDIO_GAIN_INFORMATION_HEADSET\n", 0);
        ...
        case ATTDET_PARAMETER_INDEX_AUDIO_GAIN_INFORMATION_HANDSFREE:
            // stream out levels, stream out level min value, stream out level max value, stream out level step,
            // stream in levels, stream in level min value, stream in level max value, stream in level step,
            // sidetone levels,, sidetone level min value, sidetone level max value,, sidetone level step.
            LOGMSGIDI("parameter index: ATTDET_PARAMETER_INDEX_AUDIO_GAIN_INFORMATION_HANDSFREE\n", 0);
        ...
        case ATTDET_PARAMETER_INDEX_VOICE_GAIN_INFORAMTION_HEADSET:
            // stream out levels, stream out level min value, stream out level max value, stream out level step,
            // stream in levels, stream in level min value, stream in level max value, stream in level step,
            // sidetone levels,, sidetone level min value, sidetone level max value,, sidetone level step.
            LOGMSGIDI("parameter index: ATTDET_PARAMETER_INDEX_VOICE_GAIN_INFORAMTION_HEADSET\n", 0);
        ...
        case ATTDET_PARAMETER_INDEX_VOICE_GAIN_INFORAMTION_HANDSFREE:
            // stream out levels, stream out level min value, stream out level max value, stream out level step,
            // stream in levels, stream in level min value, stream in level max value, stream in level step,
            // sidetone levels,, sidetone level min value, sidetone level max value,, sidetone level step.
            LOGMSGIDI("parameter index: ATTDET_PARAMETER_INDEX_VOICE_GAIN_INFORAMTION_HANDSFREE\n", 0);
        ...
        case ATTDET_PARAMETER_INDEX_VOICE_GAIN_INFORAMTION_RESERVED:    // stream_out: headset; stream_in: dual mic
            // stream out levels, stream out level min value, stream out level max value, stream out level step,
            // stream in levels, stream in level min value, stream in level max value, stream in level step,
            // sidetone levels,, sidetone level min value, sidetone level max value,, sidetone level step.
            LOGMSGIDI("parameter index: ATTDET_PARAMETER_INDEX_VOICE_GAIN_INFORAMTION_RESERVED\n", 0);
        ...
        case ATTDET_PARAMETER_INDEX_RECORD_GAIN_INFORMATION_NORMAL: // headset mic
            // stream out levels, stream out level min value, stream out level max value, stream out level step,
            // stream in levels, stream in level min value, stream in level max value, stream in level step,
            // sidetone levels,, sidetone level min value, sidetone level max value,, sidetone level step.
            LOGMSGIDI("parameter index: ATTDET_PARAMETER_INDEX_RECORD_GAIN_INFORMATION_NORMAL\n", 0);
        ...
        case ATTDET_PARAMETER_INDEX_RECORD_GAIN_INFORMATION_ASR:    // A-mic
            // stream out levels, stream out level min value, stream out level max value, stream out level step,
            // stream in levels, stream in level min value, stream in level max value, stream in level step,
            // sidetone levels,, sidetone level min value, sidetone level max value,, sidetone level step.
            LOGMSGIDI("parameter index: ATTDET_PARAMETER_INDEX_RECORD_GAIN_INFORMATION_ASR\n", 0);
        ...
        case ATTDET_PARAMETER_INDEX_RECORD_GAIN_INFORMATION_STEREO: // dual mic
            // stream out levels, stream out level min value, stream out level max value, stream out level step,
            // stream in levels, stream in level min value, stream in level max value, stream in level step,
            // sidetone levels,, sidetone level min value, sidetone level max value,, sidetone level step.

            LOGMSGIDI("parameter index: ATTDET_PARAMETER_INDEX_RECORD_GAIN_INFORMATION_STEREO\n", 0);
        ...
        case ATTDET_PARAMETER_INDEX_AUDIO_IIR_FILTER_INFORMATION:
            // Amount of IIR filter, IIR filter array size, IIR parameter value range(Amount of bits)
            LOGMSGIDI("parameter index: ATTDET_PARAMETER_INDEX_AUDIO_IIR_FILTER_INFORMATION\n", 0);
        ...
        case ATTDET_PARAMETER_INDEX_VOICE_NB_MODE_AND_FIR_PARAMETER_INFORMATION:
            ...
            LOGMSGIDI("parameter index: ATTDET_PARAMETER_INDEX_VOICE_NB_MODE_AND_FIR_PARAMETER_INFORMATION\n", 0);

            *out_data_buffer_size = 10;

            *out_data_buffer = EAPS_VOICE_NB_MODE_PARAMETERS_PARAMETER_SIZE;
            i++;
            *(out_data_buffer + i) = sizeof(eaps_structure.voice_parameter.voice_nb_parameter[0].voice_nb_enhancement_parameter.nb_mode_parameter[0]) * bits_per_byte;
            i++;

            *(out_data_buffer + i) = EAPS_VOICE_NB_INPUT_FIR_COEFFICIENTS_PARAMETER_SIZE;
            i++;
            *(out_data_buffer + i) = sizeof(eaps_structure.voice_parameter.voice_nb_parameter[0].voice_nb_enhancement_parameter.nb_stream_in_fir_coefficient[0]) * bits_per_byte;
            i++;
            ...
            *(out_data_buffer + i) = EAPS_VOICE_NB_OUTPUT_FIR_COEFFICIENTS_PARAMETER_SIZE;
            i++;
            *(out_data_buffer + i) = sizeof(eaps_structure.voice_parameter.voice_nb_parameter[0].voice_nb_enhancement_parameter.nb_stream_out_fir_coefficient[0]) * bits_per_byte;
            i++;
            *(out_data_buffer + i) = EAPS_FIR_FREQUENCY_AND_RESPONSE_SIZE;
            i++;
            *(out_data_buffer + i) = EAPS_FIR_FREQUENCY_AND_RESPONSE_SIZE;
        ...
        case ATTDET_PARAMETER_INDEX_VOICE_WB_MODE_AND_FIR_PARAMETER_INFORMATION:
            // mode parameter array size, mode parameter value range(Amount of bits),
            // input FIR coefficient array size, input FIR coefficient value range(Amount of bits), Amount of frquency, Amount of response,
            // output FIR coefficient array size, output FIR coefficient value range(Amount of bits), Amount of frquency, Amount of response,"
            LOGMSGIDI("parameter index: ATTDET_PARAMETER_INDEX_VOICE_WB_MODE_AND_FIR_PARAMETER_INFORMATION\n", 0);

            *out_data_buffer_size = 10;

            *out_data_buffer = EAPS_VOICE_WB_MODE_PARAMETERS_PARAMETER_SIZE;
            i++;
            *(out_data_buffer + i) = sizeof(eaps_structure.voice_parameter.voice_wb_parameter[0].voice_wb_enhancement_parameter.wb_mode_parameter[0]) * bits_per_byte;
            i++;

            *(out_data_buffer + i) = EAPS_VOICE_WB_INPUT_FIR_COEFFICIENTS_PARAMETER_SIZE;
            i++;
            *(out_data_buffer + i) = sizeof(eaps_structure.voice_parameter.voice_wb_parameter[0].voice_wb_enhancement_parameter.wb_stream_in_fir_coefficient[0]) * bits_per_byte;
            i++;
            *(out_data_buffer + i) = EAPS_FIR_FREQUENCY_AND_RESPONSE_SIZE;
            i++;
            *(out_data_buffer + i) = EAPS_FIR_FREQUENCY_AND_RESPONSE_SIZE;
            ...
            *(out_data_buffer + i) = EAPS_VOICE_WB_OUTPUT_FIR_COEFFICIENTS_PARAMETER_SIZE;
            i++;
            *(out_data_buffer + i) = sizeof(eaps_structure.voice_parameter.voice_wb_parameter[0].voice_wb_enhancement_parameter.wb_stream_out_fir_coefficient[0]) * bits_per_byte;
            i++;
            *(out_data_buffer + i) = EAPS_FIR_FREQUENCY_AND_RESPONSE_SIZE;
            i++;
            *(out_data_buffer + i) = EAPS_FIR_FREQUENCY_AND_RESPONSE_SIZE;
        ...
        case ATTDET_PARAMETER_INDEX_RECORD_WB_MODE_AND_FIR_PARAMETERS_INFORMATION:
            // mode parameter array size, mode parameter value range(Amount of bits),
            ...
            LOGMSGIDI("parameter index: ATTDET_PARAMETER_INDEX_RECORD_WB_MODE_AND_FIR_PARAMETERS_INFORMATION\n", 0);
            ...
            *(out_data_buffer + i) = EAPS_RECORD_WB_CHANNEL_2_INPUT_FIR_COEFFICIENTS_PARAMETER_SIZE;
            i++;
            *(out_data_buffer + i) = sizeof(eaps_structure.record_parameter.record_wb_parameter[0].record_wb_enhancement_parameter.record_wb_channel_2_fir_coefficient[0]) * bits_per_byte;
            i++;
            *(out_data_buffer + i) = EAPS_FIR_FREQUENCY_AND_RESPONSE_SIZE;
            i++;
            *(out_data_buffer + i) = EAPS_FIR_FREQUENCY_AND_RESPONSE_SIZE;
        ...
        default:
            LOGMSGIDI("query_useful_information_for_ui_tool: parameter index error", 0);
                            ...
                            switch (AT_command_array[0]) {
                                case EAPS_OPERATION_GET_OLD_VALUE:
                                    ...
                                    *(EAPS_operation_is_get_out_data_buffer + i) = EAPS_structure->voice_parameter.voice_nb_parameter[AT_command_array[2] - EAPS_DEVICE_MODE_VOICE_NB_MODE_1].voice_nb_gain.sidetone_gain;
                                    ...
                                    // debug
                                    LOGMSGIDI("EAPS, voice nb mode[%d], gain parameter\n", 1, AT_command_array[2]);
                                    //for (i = 0; i < *EAPS_operation_is_get_out_data_buffer_size; i++) {
                                    //    LOGI("*(EAPS_operation_is_get_out_data_buffer+%d)=%d", i, *(EAPS_operation_is_get_out_data_buffer + i));
                                    //}
                            ...
                            switch (AT_command_array[0]) {
                                case EAPS_OPERATION_GET_OLD_VALUE:
                                    ...
                                    *(EAPS_operation_is_get_out_data_buffer + i) = EAPS_structure->voice_parameter.voice_wb_parameter[AT_command_array[2] - EAPS_DEVICE_MODE_VOICE_WB_MODE_1].voice_wb_gain.sidetone_gain;
                                    ...
                                    // debug
                                    LOGMSGIDI("EAPS, voice wb mode[%d], gain parameter\n", 1, AT_command_array[2]);
                                    //for (i = 0; i < *EAPS_operation_is_get_out_data_buffer_size; i++) {
                                    //    LOGI("*(EAPS_operation_is_get_out_data_buffer+%d)=%d", i, *(EAPS_operation_is_get_out_data_buffer + i));
                                    //}
                            ...
                            switch (AT_command_array[0]) {
                                case EAPS_OPERATION_GET_OLD_VALUE:
                                    ...
                                    *EAPS_operation_is_get_out_data_buffer_size = EAPS_RECORD_WB_CHANNEL_2_INPUT_FIR_COEFFICIENTS_PARAMETER_SIZE + EAPS_FIR_FREQUENCY_AND_RESPONSE_SIZE + EAPS_FIR_FREQUENCY_AND_RESPONSE_SIZE;
                                    ...
                                    // debug
                                    LOGMSGIDI("EAPS_PARAMETER_INDEX_RECORD_CHANNEL_2_INPUT_FIR_COEFFICIENTS, record wb Device mode = %d\n", 1, AT_command_array[2] - EAPS_DEVICE_MODE_RECORD_WB_MODE_1);
