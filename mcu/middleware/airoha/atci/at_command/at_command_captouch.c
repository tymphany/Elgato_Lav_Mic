    ...
    */
    ...
    switch (parse_cmd->mode) {
        case ATCI_CMD_MODE_TESTING:
            ...
            */
            strncpy((char *)resonse.response_buf, "ATCI_CMD_MODE_TESTING", strlen("ATCI_CMD_MODE_TESTING") + 1);
            resonse.response_len = strlen((char *)resonse.response_buf);
        ...
        case ATCI_CMD_MODE_EXECUTION:
            strncpy((char *)resonse.response_buf, "ATCI_CMD_MODE_EXECUTION", strlen("ATCI_CMD_MODE_EXECUTION") + 1);
            resonse.response_len = strlen((char *)resonse.response_buf);
            resonse.response_flag = ATCI_RESPONSE_FLAG_APPEND_OK;
            atci_send_response(&resonse);
            ...
            */
            if (strncmp(param1, "AT+ECPT=RW_RG", strlen("AT+ECPT=RW_RG")) == 0) {
                ...
                param3 = strtok(NULL, ",");
                param4 = strtok(NULL, ",");
                if ((sizeof(temp1) > strlen((char *)param3)) && (sizeof(temp2) > strlen((char *)param4))) {
                    strncpy((char *)temp1, (char *)param3, strlen((char *)param3) + 1);
                    strncpy((char *)temp2, (char *)param4, strlen((char *)param4) + 1);
            ...
            */
            if (strncmp(param1, "AT+ECPT=INIT", strlen("AT+ECPT=INIT")) == 0) {
                ...
                strncpy((char *)temp1, (char *)param2, strlen((char *)param2) + 1);
                strncpy((char *)temp2, (char *)param3, strlen((char *)param3) + 1);
            ...
            */
            if (strncmp(param1, "AT+ECPT=CAL_KEY", strlen("AT+ECPT=CAL_KEY")) == 0) {
                ...
                nvkey_read_data(NVID_CPT_CALI_4CHDATA, (uint8_t *)(&captouch_data), &temp);
                ...
                atci_captouch_send_response((int32_t *)&ret_len2, &resonse);
