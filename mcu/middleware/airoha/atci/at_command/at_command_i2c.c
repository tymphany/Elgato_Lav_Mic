...
const char *help_str_i2c_mst    = "AT+EI2C=HQA,port,freq,pattern,snd_sz,recv_sz\r\nOK\r\n";
const char *cmd_str_hqa_i2c_mst = "AT+EI2C=HQA,";

ATTR_RWDATA_IN_NONCACHED_SYSRAM_4BYTE_ALIGN uint8_t s_i2c_txbuf[MAX_I2C_TX_BUFF_SZ];
ATTR_RWDATA_IN_NONCACHED_SYSRAM_4BYTE_ALIGN uint8_t s_i2c_rxbuf[MAX_I2C_RX_BUFF_SZ];
