            ...
            if (param != NULL && ((param1_val >= 0) && (param1_val <= 3))) {
                ...
                if (param1_val == 1) {
                    ...
                    if (keypad_custom_init() == true) {
                        ...
                        hal_keypad_register_callback((hal_keypad_callback_t)atci_keypad_handler, NULL);
                        hal_keypad_enable();
#ifdef HAL_KEYPAD_FEATURE_POWERKEY
                        hal_keypad_powerkey_register_callback((hal_powerkey_callback_t)atci_keypad_powerkey_handler, NULL);
#endif
