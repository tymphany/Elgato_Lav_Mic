...
#define ATCI_UART_TX_FIFO_BUFFER_SIZE (128)
#elif defined MTK_ATCI_BUFFER_LENGTH_256
#define ATCI_UART_TX_FIFO_BUFFER_SIZE (256)
#elif defined MTK_ATCI_BUFFER_LENGTH_512
#define ATCI_UART_TX_FIFO_BUFFER_SIZE (512)
#else
#ifdef MTK_ATCI_BUFFER_SLIM
#define ATCI_UART_TX_FIFO_BUFFER_SIZE (600)
#else
...
/** @brief This structure defines the response structure. For more information, please refer to #atci_send_heavy_response() function.*/

typedef struct {
    uint8_t  *response_buf;             /**< The response data buffer. */
    uint16_t response_len;              /**< The actual data length of response_buf. */
    uint32_t response_flag;             /**< For more information, please refer to #atci_response_flag_t. */

} atci_response_heavy_data_t;
...
/**
 * @brief This function sends the AT command response heavy data or the URC heavy data.
 * @param[in] response is the response data. For more details about this parameter, please refer to #atci_response_heavy_data_t.
 * @return    #ATCI_STATUS_OK the ATCI module sent data to the UART successfully. \n
 */
 ...
 * @param[in] port is the serial port number used to data transmission for ATCI.
 ...
 * @endcode
 */
extern atci_status_t     atci_init(uint16_t port);
...
/**
 * @brief This function defines atci task
 * @return    void.
 */
extern void     atci_task(void);
