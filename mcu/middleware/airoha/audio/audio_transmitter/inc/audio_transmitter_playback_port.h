...
extern void audio_transmitter_reset_share_info_by_block(n9_dsp_share_info_t *p_share_info, uint32_t buffer_start_address, uint16_t buffer_length, uint32_t max_payload_size);
