...
void audio_transmitter_adaptive_eq_monitor_open_playback(audio_transmitter_config_t *config, mcu2dsp_open_param_t *open_param)
{
    ...
    open_param->stream_in_param.afe.with_bias_lowpower = AUDIO_MICBIAS_NORMAL_MODE;
    ...
    TRANSMITTER_LOG_I("audio_transmitter_adaptive_eq_monitor_open_playback in_device:0x%x out_device:0x%x", 2, open_param->stream_in_param.afe.audio_device, open_param->stream_out_param.afe.audio_device);
}
