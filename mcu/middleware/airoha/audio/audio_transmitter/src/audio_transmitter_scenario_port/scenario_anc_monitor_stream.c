...
void audio_transmitter_anc_monitor_open_playback(audio_transmitter_config_t *config, mcu2dsp_open_param_t *open_param)
{
    ...
    if (open_param->stream_in_param.afe.audio_device4 != 0) {
    ...
    if (open_param->stream_in_param.afe.audio_device5 != 0) {
    ...
    if (open_param->stream_in_param.afe.audio_device6 != 0) {
    ...
    if (open_param->stream_in_param.afe.audio_device7 != 0) {
