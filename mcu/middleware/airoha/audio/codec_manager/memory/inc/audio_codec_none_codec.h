...
#ifndef __AUDIO_CODEC_NONE_ENCODER_H__
#define __AUDIO_CODEC_NONE_ENCODER_H__
...
typedef enum {
    NONE_CODEC_PARAM_ERROR = -3,
    NONE_CODEC_LEN_ERROR = -2,
    NONE_CODEC_ERROR = -1,
    NONE_CODEC_SUCCESS = 0
} none_codec_result_t;

typedef struct {
    uint32_t oneframe_byte_length;
} none_codec_config_t;
...
#endif//__AUDIO_CODEC_NONE_ENCODER_H__