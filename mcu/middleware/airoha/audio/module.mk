...
ifeq ($(MTK_TEMP_REMOVE), y)
  ...
  ifeq ($(AIR_NVDM_ENABLE), y)
    ...
    ifeq ($(IC_CONFIG),ab155x)
      ...
      AUDIO_FILES += $(AUDIO_SRC)/port/mt2833/src/audio_nvdm.c
      ...
      AUDIO_FILES += $(AUDIO_SRC)/port/$(IC_CONFIG)/src/audio_nvdm.c
    endif
...
LIBS += $(SOURCE_DIR)/prebuilt/middleware/airoha/audio/amr_codec/lib/arm_cm4/libamr.a
endif
...
ifeq ($(MTK_AUDIO_AAC_DECODER_ENABLED),y)
    ...
    LIBS += $(SOURCE_DIR)/prebuilt/middleware/airoha/audio/aac_codec/lib/libheaac_decoder.a
endif
...
ifeq ($(MTK_SBC_ENCODER_ENABLE), y)
    ifeq ($(AIR_BTA_IC_PREMIUM_G3), y)
      LIBS += $(SOURCE_DIR)/prebuilt/middleware/airoha/audio/sbc_codec/lib/arm_cm33/libsbc_encoder_CM33.a
    else
      LIBS += $(SOURCE_DIR)/prebuilt/middleware/airoha/audio/sbc_codec/lib/arm_cm4/libsbc_encoder.a
    endif
endif
...
ifeq ($(MTK_AVM_DIRECT), y)
    ...
    ifneq ($(filter y,$(AIR_LE_AUDIO_ENABLE) $(AIR_BLE_ULTRA_LOW_LATENCY_ENABLE)),)
...
CFLAGS += -I$(SOURCE_DIR)/middleware/airoha/audio/mp3_codec/inc
...
ifeq ($(MTK_AVM_DIRECT), y)
    ifeq ($(AIR_BT_CODEC_ENABLED),y)
        ...
        CFLAGS  += -I$(SOURCE_DIR)/prebuilt/middleware/airoha/bluetooth/inc
        ifeq ($(MTK_BT_A2DP_SOURCE_ENABLE), y)
            CFLAGS  += -I$(SOURCE_DIR)/middleware/airoha/audio/sbc_codec/inc
        endif
    endif
...
ifeq ($(AIR_WAV_DECODER_ENABLE),y)
  ...
  LIBS += $(SOURCE_DIR)/middleware/airoha/audio/wav_codec/lib/arm_cm4/libwav_codec.a
  CFLAGS += -I$(SOURCE_DIR)/middleware/airoha/audio/wav_codec/inc
...
ifeq ($(AIR_MP3_DECODER_ENABLE),y)
  ...
  LIBS += $(SOURCE_DIR)/prebuilt/middleware/airoha/audio/mp3_codec/lib/arm_cm4/libmp3dec.a
endif
...
ifeq ($(AIR_ADVANCED_PASSTHROUGH_ENABLE),y)
  ifeq ($(IC_CONFIG),ab156x)
    PSAP_SOURCE_CODE = $(strip $(SOURCE_DIR))/middleware/airoha/audio/psap_protected/GCC/module.mk
    ifeq ($(PSAP_SOURCE_CODE), $(wildcard $(PSAP_SOURCE_CODE)))
      include $(SOURCE_DIR)/middleware/airoha/audio/psap_protected/GCC/module.mk
    else
    ...
    include $(SOURCE_DIR)/prebuilt/middleware/airoha/audio/psap/module.mk
    endif
  endif
endif
