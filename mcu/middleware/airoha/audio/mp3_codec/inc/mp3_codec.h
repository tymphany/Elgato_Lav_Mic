...
struct mp3_media_handle_s {
    ...
    mp3_codec_mp3_id3v2_information_t  id3v2_information;    /**< ID3v2 information. */
 ...
 * @return    Media handle of the MP3 codec. Please refer to #mp3_codec_media_handle_t.
 * @sa        #mp3_codec_close()
 */
