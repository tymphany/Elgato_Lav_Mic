...
#define MAX_MP3_CODEC_FUNCTIONS      5
...
typedef enum {
    ...
    MP3_CODEC_QUEUE_EVENT_PLAY,
    MP3_CODEC_QUEUE_EVENT_STOP,
    MP3_CODEC_QUEUE_EVENT_SYNC_TRIGGER,
...
typedef struct {
    ...
    int32_t MP3SilenceFrameSize; // in bytes
    uint8_t MP3SilenceFrameHeader[4];
#endif
