...
ATTR_LOG_STRING_LIB  g_ANC_msg_id_string_126[] = LOG_DEBUG_PREFIX(anc) "ANC_RUNTIME_GAIN_CONVERT_RAMP_GAIN ch[%d] runtime_gain(%d) extend(%d)(%d)(%d)(%d)(%d)";
...
ATTR_LOG_STRING_LIB  g_ANC_msg_id_string_129[] = LOG_DEBUG_PREFIX(anc) "[FADP] DEMO, ANC has been enabled. Ignore request. Change demo state(%d) only.";
...
ATTR_LOG_STRING_LIB  g_ANC_msg_id_string_134[] = LOG_DEBUG_PREFIX(anc) "[FADP]mcu shap_debug index0 success (0x%x)(%d)";
ATTR_LOG_STRING_LIB  g_ANC_msg_id_string_135[] = LOG_DEBUG_PREFIX(anc) "[FADP]mcu shap_debug index0 fail";
