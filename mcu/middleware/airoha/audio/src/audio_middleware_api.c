...
#define LOGMSGIDE(fmt,arg...)   LOG_MSGID_E(audio_middleware_api, "[audio_middleware_api]"fmt,##arg)
#define LOGMSGIDW(fmt,arg...)   LOG_MSGID_W(audio_middleware_api, "[audio_middleware_api]"fmt,##arg)
#define LOGMSGIDI(fmt,arg...)   LOG_MSGID_I(audio_middleware_api, "[audio_middleware_api]"fmt,##arg)
...
void audio_middleware_set_default_enhancement_parameters()
{
    ...
    LOGMSGIDI("audio middleware set default enhancement parameters ++\n", 0);



#if PRODUCT_VERSION == 2523 // TODO: not using this method, we may set default enhancement in spicific file
...
int audio_middleware_init()
{
    ...
    LOGMSGIDI("audio middleware init ++\n", 0);
