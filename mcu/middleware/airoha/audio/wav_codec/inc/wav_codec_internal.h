...
#define TASK_LOGMSGID_E(fmt,arg...)      LOG_MSGID_E(WAV_CODEC, "[WAV_CODEC] "fmt,##arg)
#define TASK_LOGMSGID_W(fmt,arg...)      LOG_MSGID_W(WAV_CODEC, "[WAV_CODEC] "fmt,##arg)
#define TASK_LOGMSGID_I(fmt,arg...)      LOG_MSGID_I(WAV_CODEC, "[WAV_CODEC] "fmt,##arg)
#define TASK_LOGMSGID_D(fmt,arg...)      LOG_MSGID_D(WAV_CODEC, "[WAV_CODEC] "fmt,##arg)
...
#if defined(MTK_AVM_DIRECT)
    audio_message_type_t        message_type;
