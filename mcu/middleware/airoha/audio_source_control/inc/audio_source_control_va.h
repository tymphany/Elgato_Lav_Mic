...
#ifndef __AUDIO_SOURCE_CONTROL_VA_H__
#define __AUDIO_SOURCE_CONTROL_VA_H__
...
void audio_source_control_va_handler(unsigned char handle_id, audio_source_control_request_result_t judge_result);
...
#endif /* __AUDIO_SOURCE_CONTROL_VA_H__ */
