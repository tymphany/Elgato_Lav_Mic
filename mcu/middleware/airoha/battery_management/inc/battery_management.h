 ...
 * @section BMT_Terms_Chapter Terms and acronyms
 *
 * |Terms                   |Details                                                                 |
 * |------------------------------|------------------------------------------------------------------------|
...
typedef enum {
    ...
    BATTERY_PROPERTY_VOLTAGE_IN_PERCENT, 	/**< battery In Percent. */
    BATTERY_PROPERTY_PMIC_TEMPERATURE, 		/**< pmic temperature. */
    BATTERY_PROPERTY_CHARGER_STATE, 		/**< charger state. */
#ifdef MTK_FUEL_GAUGE
    BATTERY_PROPERTY_UI_SOC,                /**< Remaining battery capacity in an integer percentage form (base on fuel gauge). */
#endif
} battery_property_t;
...
typedef enum {
    ...
    BATTERY_MANAGEMENT_EVENT_CHARGER_STATE_UPDATE       = 0x00000002,  /**< Battery charger state change event. */
    BATTERY_MANAGEMENT_EVENT_MESSAGE_UPDATE             = 0x00000004,  /**< Battery message update event. */
    BATTERY_MANAGEMENT_EVENT_CHARGER_EXIST_UPDATE       = 0x00000008,  /**< Battery charger exist update event. */
    BATTERY_MANAGEMENT_EVENT_CHARGER_ITERM              = 0x00000010,  /**< Battery charger exist update event. */
    BATTERY_MANAGEMENT_EVENT_CHARGER_ITERM_CURRENT      = 0x00000011,  /**< Battery charger exist update event. */
...
*   */
battery_management_status_t battery_management_init();
...
* |<b>BATTERY_PROPERTY_VOLTAGE_IN_PERCENT</b>   |Battery capacity's unit is percentage (%). Note: 25x3 series IC do not support this feature.|
* |<b>BATTERY_PROPERTY_PMIC_TEMPERATURE</b>     |Battery tempertature (unit is celsius). Note: 25x3 series IC do not support this feature.|
* |<b>BATTERY_PROPERTY_CHARGER_STATE</b>        |Charger status. Note: 25x3 series IC do not support this feature.|
* */
