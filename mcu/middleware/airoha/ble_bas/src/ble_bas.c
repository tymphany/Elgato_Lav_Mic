...
bt_status_t ble_bas_notify_battery_level(bt_handle_t conn_handle, uint8_t battery_level)
{
    ...
    LOG_MSGID_I(BLE_BAS, "ble_bas_notify_battery_level, new battery level is %d\r\n", 1, battery_level);
    ...
    if (conn_handle > 0) {
        ...
        LOG_MSGID_I(BLE_BAS, "ble_bas_notify_battery_level conn_handle is %x, battery_level is %d\r\n", 2, conn_handle, battery_level);
