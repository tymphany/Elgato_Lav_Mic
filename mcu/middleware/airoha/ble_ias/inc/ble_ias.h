 ...
 * - Step 1. Add IAS service to the application's GATT service database. And then return the bt_gatts_service_t pointer to GATTS stack by implementing the user-defined callback @ref bt_gatts_get_server_by_handle().
 *  - Sample Code:
 *     @code
 ...
 *                   NULL
 *                };
 *                const bt_gatts_service_t** bt_gatts_get_server_by_handle()
 *                {
