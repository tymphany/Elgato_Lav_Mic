...
log_create_module_variant(BTIF, DEBUG_LOG_ON, PRINT_LEVEL_WARNING);
log_create_module_variant(BTL2CAP, DEBUG_LOG_OFF, PRINT_LEVEL_INFO);
log_create_module_variant(BTHCI, DEBUG_LOG_OFF, PRINT_LEVEL_INFO);
