 ...
 * @param[in] length              is the length of a UTF-8 string pointed to device_name in octets (shall be 0 to 248 octets).
...
/**
 * @brief   This function sets Peripheral Preferred Connection Parameters Characteristic. It should be called after @ref bt_gatts_service_init().
