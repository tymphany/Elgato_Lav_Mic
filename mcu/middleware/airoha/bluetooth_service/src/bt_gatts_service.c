...
#define BT_GATTS_GATT_SRV_END_HANDLE                                  0x0019
#else
#define BT_GATTS_GATT_SRV_START_HANDLE            (0x0011)
...
static uint8_t bt_gatts_gap_service_desc_list[] = {
...
static uint8_t bt_gatts_gatt_service_desc_list[] = {
