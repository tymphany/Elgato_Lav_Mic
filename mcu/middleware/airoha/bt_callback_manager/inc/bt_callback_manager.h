...
typedef enum {
    ...
    bt_callback_type_gap_get_tx_power_configuration,             /**< Cannot have more than one callback registered for this callback type. The prototype of the callback function for this callback type is defined as #bt_gap_get_tx_power_configuration(). */
#endif
    ...
    bt_callback_type_gap_le_rho_request,                         /**< Must have one and only one callback registered for this callback type. The prototype of the callback function for this callback type is defined as gap le rho request. */
...
#define MODULE_MASK_CTP    MODULE_MASK_OFFSET(BT_MODULE_CTP)         /**< To get the module offset of the #BT_MODULE_CTP. */
#define MODULE_MASK_AIRUPDATE MODULE_MASK_OFFSET(BT_MODULE_AIRUPDATE)   /**< To get the module offset of the #BT_MODULE_AIRUPDATE. */
#define MODULE_MASK_HID    MODULE_MASK_OFFSET(BT_MODULE_HID)         /**< To get the module offset of the #BT_MODULE_HID. */
#define MODULE_MASK_MAP    MODULE_MASK_OFFSET(BT_MODULE_MAP)         /**< To get the module offset of the #BT_MODULE_MAP. */
#endif
#define MODULE_MASK_LE_AUDIO  MODULE_MASK_OFFSET(BT_MODULE_LE_AUDIO)    /**< To get the module offset of the #BT_MODULE_LE_AUDIO. */
#define MODULE_MASK_OTP         MODULE_MASK_OFFSET(BT_MODULE_OTP)              /**< To get the module offset of the #BT_MODULE_OTP. */
#define MODULE_MASK_ULL    MODULE_MASK_OFFSET(BT_MODULE_ULL)              /**< To get the module offset of the #BT_MODULE_ULL. */
...
/**
 * @brief     This function is used to remove a specified SDP record that was a previously added. For more information about how to remove a record, please refer to the bt_sdp.h.
 * @param[in] record   is the pointer to the record.
 * @return             #BT_STATUS_SUCCESS, if the record was removed successfully.
 *                     #BT_STATUS_FAIL, no corresponding record was found.
 */
bt_status_t bt_callback_manager_remove_sdp_customized_record(const bt_sdps_record_t *record);

/**
 * @brief     This function adds a l2cap user config to the l2cap stack.
 * @param[in] config   is the pointer to the config of the customer profile.
 * @return             #BT_STATUS_SUCCESS, if the config was added successfully.
 *                     #BT_STATUS_FAIL, if the maximum number of records, as defined by #BT_CALLBACK_MANAGER_L2CAP_USER_PROFILE_MAX in bt_callback_manager_config.h, has been reached.
 */
