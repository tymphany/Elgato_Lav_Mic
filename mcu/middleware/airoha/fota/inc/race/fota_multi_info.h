...
/**
 * File: fota_multi_info.h
 *
 * Description: This file defines the multiple information needed macros and the interfaces of fota_multi_info.c.
 *
...
#define FOTA_DL_INTEGRITY_RES_VAL_PASS         (0x00) /* The passed result of the FOTA package integrity check. */
#define FOTA_DL_INTEGRITY_RES_VAL_FAIL         (0x01) /* The failed result of the FOTA package integrity check. */
#define FOTA_DL_INTEGRITY_RES_VAL_EMPTY        (0xFF) /* It represents there is no FOTA package integrity check result. */
