...
/**
 * File: fota_flash_for_gsound.c
 *
 * Description: This file defines and implements the interfaces for Gsound FOTA.
 */
...
bool g_bisto_fota_running; /* The variable indicates if the Bisto FOTA is running or not. */
