 ...
 *    serial_port_open_para.tx_buffer_size = 512;
 *    serial_port_open_para.rx_buffer_size = 512;
 ...
 * @}
 */
#endif /*End MTK_PORT_SERVICE_SLIM_ENABLE*/
...
typedef enum {
    ...
    SERIAL_PORT_DEV_BT_TYPE_BEGIN,                              /**< The first valid BT port in the port service of a device. */
    SERIAL_PORT_DEV_BT_SPP = SERIAL_PORT_DEV_BT_TYPE_BEGIN,     /**< BT SPP port in the port service of a device. */
    SERIAL_PORT_DEV_BT_LE,                                      /**< BT BLE port in the port service of a device. */
    SERIAL_PORT_DEV_BT_LE_1,                                      /**< BT BLE port in the port service of a device. */
    SERIAL_PORT_DEV_BT_LE_2,                                      /**< BT BLE port in the port service of a device. */
#ifdef MTK_GATT_OVER_BREDR_ENABLE
    SERIAL_PORT_DEV_BT_GATT_OVER_BREDR,                         /**< BT GATT over BR/EDR port in the port service of a device. */
#endif
#ifdef MTK_AIRUPDATE_ENABLE
    SERIAL_PORT_DEV_BT_AIRUPDATE,                               /**< BT Airupdate port in the port service of a device. */
    SERIAL_PORT_DEV_BT_TYPE_END = SERIAL_PORT_DEV_BT_AIRUPDATE,    /**< The last valid BT port in the port service of a device. */
#else
#ifdef MTK_GATT_OVER_BREDR_ENABLE
    SERIAL_PORT_DEV_BT_TYPE_END = SERIAL_PORT_DEV_BT_GATT_OVER_BREDR,    /**< The last valid BT port in the port service of a device. */
#else
    SERIAL_PORT_DEV_BT_TYPE_END = SERIAL_PORT_DEV_BT_LE_2,    /**< The last valid BT port in the port service of a device. */
#endif
#endif
#endif
#ifdef MTK_IAP2_PROFILE_ENABLE
    SERIAL_PORT_DEV_IAP2_TYPE_BEGIN,                            /**< The first valid iAP2 port in the port service of a device. */
    SERIAL_PORT_DEV_IAP2_SESSION1 = SERIAL_PORT_DEV_IAP2_TYPE_BEGIN,/**< EA session1 in the port service of a device. */
    SERIAL_PORT_DEV_IAP2_SESSION2,                              /**< EA session2 in the port service of a device. */
    SERIAL_PORT_DEV_IAP2_SESSION3,                              /**< EA session3 in the port service of a device. */
    SERIAL_PORT_DEV_IAP2_SESSION4,                              /**< EA session4 in the port service of a device. */
    SERIAL_PORT_DEV_IAP2_TYPE_END = SERIAL_PORT_DEV_IAP2_SESSION4,  /**< The last valid iAP2 port in the port service of a device. */
#endif
#if defined(AIR_RACE_SCRIPT_ENABLE)
    SERIAL_PORT_DEV_PSEUDO,                                     /**< pseudo port for race_script test via mux. */
#endif
#if defined(AIR_LOW_LANTENCY_MUX_ENABLE)
    SERIAL_PORT_DEV_LL_UART_TYPE_BEGIN,
    SERIAL_PORT_DEV_LL_UART_0 = SERIAL_PORT_DEV_LL_UART_TYPE_BEGIN,
    SERIAL_PORT_DEV_LL_UART_1,
    SERIAL_PORT_DEV_LL_UART_2,
    SERIAL_PORT_DEV_LL_UART_TYPE_END = SERIAL_PORT_DEV_LL_UART_2,
#endif
#if defined(AIR_MUX_BT_HID_ENABLE)
    SERIAL_PORT_DEV_HID_TYPE_BEGIN,
    SERIAL_PORT_DEV_HID_CONTROL = SERIAL_PORT_DEV_HID_TYPE_BEGIN,
    SERIAL_PORT_DEV_HID_INTERUPT,
    SERIAL_PORT_DEV_HID_TYPE_END = SERIAL_PORT_DEV_HID_INTERUPT,
#endif
...
#ifdef MTK_PORT_SERVICE_BT_ENABLE
    SERIAL_PORT_TYPE_BT,                                       /**< BT port type in the port service. */
#endif
#ifdef MTK_IAP2_PROFILE_ENABLE
    SERIAL_PORT_TYPE_IAP2,                                      /**< iAP2 port type in the port service. */
#endif
...
typedef enum {
    ...
    SERIAL_PORT_CMD_GET_WRITE_AVAIL,            /**< UART or USB or BT special command to get the current available space to store the transmit data. */
    SERIAL_PORT_CMD_GET_READ_AVAIL,             /**< UART or USB or BT special command to get the current available size for the received data. */
    SERIAL_PORT_CMD_GET_CONNECTION_PARAM,       /**< iAP2 special command to get connection parameters. */
    SERIAL_PORT_CMD_SET_RX_PARAM,               /**< iAP2 special command to set rx paramete. */
...
typedef enum {
    ...
    SERIAL_PORT_EVENT_BT_CONNECTION,            /**< BT connection event. */
    SERIAL_PORT_EVENT_BT_DISCONNECTION,         /**< BT disconnection event. */
    SERIAL_PORT_EVENT_WAKEUP_SLEEP,             /**< UART wakeup sleep event. */
    SERIAL_PORT_EVENT_IAP2_SESSION_OPEN,        /**< iAP2 session open event. */
    SERIAL_PORT_EVENT_IAP2_SESSION_CLOSE,       /**< iAP2 session close event. */
    SERIAL_PORT_EVENT_BT_HID_DISCONNECTION
 ...
 * using #SERIAL_PORT_CMD_GET_CONNECTION_PARAM.
 */
typedef struct {
...
#ifdef MTK_PORT_SERVICE_SLIM_ENABLE
    uint32_t tx_buffer_size;                   /**< size of internal send buffer. */
    uint32_t rx_buffer_size;                   /**< size of internal receive buffer. */
#endif
...
typedef union {
    ...
    serial_port_get_connection_param_t serial_port_get_connection_param; /**< Parameters for IAP2 special get connection param command. */
    serial_port_set_config_param_t serial_port_set_config_param;    /**< Parameters for iAP2 special set configuration parameters command. */
...
#endif  /*End MTK_PORT_SERVICE_ENABLE*/
#endif  /*End __SERIAL_PORT_H__*/
