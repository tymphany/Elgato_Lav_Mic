...
#ifndef _RACE_CMD_AUDIO_LOOPBACK_TEST_H_
#define _RACE_CMD_AUDIO_LOOPBACK_TEST_H_
...
typedef struct {
    ...
    int32_t SNP;
    uint32_t TOTAL_POW;
} PACKED race_audio_loopback_test_result_t;
...
#endif //_RACE_CMD_AUDIO_LOOPBACK_TEST_H_
