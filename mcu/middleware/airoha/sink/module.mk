...
ifneq ($(VENDOR_LIB), $(wildcard $(VENDOR_LIB)))
#$(error If BT vendor codec doesn't exist in dsp side, user can't enable AIR_BT_A2DP_VENDOR_ENABLE)
else
CFLAGS   += -DAIR_BT_A2DP_VENDOR_ENABLE
CFLAGS   += -DMTK_BT_A2DP_VENDOR_CODEC_SUPPORT
ifeq ($(AIR_BT_A2DP_VENDOR_CODEC_BC_ENABLE), y)
...
LIBS += $(SOURCE_DIR)/prebuilt/$(MIDDLEWARE_PROPRIETARY)/bluetooth/lib/libavm_direct.a
