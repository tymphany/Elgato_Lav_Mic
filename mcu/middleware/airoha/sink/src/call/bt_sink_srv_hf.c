    ...
    switch (event_id) {
        ...
        case BT_SINK_SRV_CALL_PSD_EVENT_REJECT: {
            ...
            if (hf_context) {
                ...
                } else if ((BT_SINK_SRV_INTERRUPT_OPERATION_TRANSFER_CALL_AUDIO & config.reject_config.reject_operation) &&
        ...
        case BT_SINK_SRV_CALL_PSD_EVENT_SUSPEND: {
            ...
            if (NULL != context) {
                ...
                } else if ((BT_SINK_SRV_INTERRUPT_OPERATION_TRANSFER_CALL_AUDIO & config.suspend_config.suspend_operation) &&
        ...
        case BT_SINK_SRV_CALL_PSD_EVENT_RESUME: {
            ...
            if (NULL != context) {
                ...
                } else if ((BT_SINK_SRV_INTERRUPT_OPERATION_TRANSFER_CALL_AUDIO & config.resume_config.resume_operation) &&
                    !(BT_SINK_SRV_HF_FLAG_SCO_CREATED & context->link.flag)) {
    ...
    switch (msg) {
        ...
        case BT_HFP_SLC_CONNECTED_IND: {
            ...
            if (NULL != bt_sink_srv_hf_context_p) {
                ...
                bt_sink_srv_report_id("[CALL][HF]XAPL specific features:0x%x", 1, xapl_features->features);
        ...
        case BT_HFP_HF_INDICATOS_ENABLE_IND: {
            ...
            if ((enable_ind->enable) && (hf_context != NULL)) {
                ...
                bt_sink_srv_report_id("[CALL][HF]HF INDICATORS ENABLE, context 0x%x feature 0x%x", 2, hf_context, hf_context->link.hf_indicators_feature);
            }
        }
        break;
        default:
