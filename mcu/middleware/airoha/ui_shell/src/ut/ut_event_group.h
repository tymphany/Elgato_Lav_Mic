...
#ifndef __UT_EVENTS_EVENT_GROUP_H__
#define __UT_EVENTS_EVENT_GROUP_H__
...
#define APP1_CARE_KEY_ID    1
#define APP2_CARE_KEY_ID    2
#define TEST_ALLOW_KEY_ID   3

enum {
    ALL_ALLOW_REQUEST_ID    = 0,
    ALL_PENDING_REQUEST_ID  = 1,
};

#endif /* __UT_EVENTS_EVENT_GROUP_H__ */
