...
typedef struct {
    ...
    UARTDCBStruct               DCB_TEMP; /* USB_FPGA_DVT : Rename : DCB -> DCB_TEMP to skip build error */
...
extern void USB2UART_Thru_DMATransmit(uint32_t port, uint8_t *buffaddr, uint16_t length);
