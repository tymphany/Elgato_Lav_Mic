...
#define USB_AUDIO_RX_BUFFER_SIZE     2304 // (1152x2, 576x4, 288x8, 192x12)
...
typedef struct {
    ...
    uint16_t            spk_cur_channel_vol[USB_AUDIO_MAX_CHANNEL_NUM];
    uint16_t            mic_cur_channel_vol[USB_AUDIO_MAX_CHANNEL_NUM];
