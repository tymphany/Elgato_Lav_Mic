...
CFLAGS += -I$(SOURCE_DIR)/$(MIDDLEWARE_PROPRIETARY)/verno/inc
...
$(OUTPATH)/$(PROJ_NAME).elf: $(BUILD_DIR)/$(MIDDLEWARE_PROPRIETARY)/verno/verno.o

$(BUILD_DIR)/$(MIDDLEWARE_PROPRIETARY)/verno/verno.o: $(BUILD_DIR)/$(MIDDLEWARE_PROPRIETARY)/verno/verno.c
	@mkdir -p $(dir $@)
	@echo Build... $$(basename $@)
...
$(BUILD_DIR)/$(MIDDLEWARE_PROPRIETARY)/verno/verno.c: FORCE
	@mkdir -p $(dir $@); \
	$(SOURCE_DIR)/$(MIDDLEWARE_PROPRIETARY)/verno/gen_verno.sh $(SOURCE_DIR)/$(MIDDLEWARE_PROPRIETARY)/verno/verno.template $@ $(MTK_FW_VERSION) $(BOARD_CONFIG) $(SOURCE_DIR)
