...
#define MBEDTLS_ECP_DP_SECP160R1_ENABLED  // SPOT with SECP160R1, cannot support ECP_NIST_OPTIM
#endif
...
#ifndef AIR_SPOT_ENABLE
#define MBEDTLS_ECP_NIST_OPTIM            // CUST_PAIR with SECP256R1, support ECP_NIST_OPTIM
#endif
