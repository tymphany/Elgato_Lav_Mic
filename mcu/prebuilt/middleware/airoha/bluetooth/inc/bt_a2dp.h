...
BT_PACKED(
typedef struct {
    uint8_t drc:1;              /**< MPEG-D DRC is not supported with MPEG-2 AAC LC. */
    uint8_t object_type:7;      /**< The object type, b0: MPEG4 AAC-ELDv2 b1: MPEG4 HE-AACv2 b2: MPEG4 HE-AAC, b3: MPEG4 AAC scalable, b4: MPEG4 AAC LTP, b5: MPEG4 AAC LC, b6: MPEG2 AAC LC. */
    ...
    uint8_t channels:4;         /**< b0: 8(7.1), b1: 6(5.1), b2: 2, b3: 1. */
