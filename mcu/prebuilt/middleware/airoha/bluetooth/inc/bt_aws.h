 ...
 *     // Device B
 *
 *     // Starts a timer to wait before playing the music, after receiving the #BT_AWS_NOTIFY_PLAY_IND notification ID.
 *       bt_aws_play_notify_t *play_noti;
...
#define BT_AWS_COMMAND_IND                       (BT_MODULE_AWS | 0x000C)               /**< A command request is initiated from a remote device with the #bt_aws_command_ind_t payload. Call #bt_aws_send_command() to accept or reject the request. */
#define BT_AWS_NOTIFY_PLAY_IND                   (BT_MODULE_AWS | 0x000E)               /**< The notify indication is initiated from a remote device with the  #bt_aws_play_notify_t payload. */
...
/**
 * @brief This structure defines the AWS play time with a notification ID #BT_AWS_NOTIFY_PLAY_IND.
 */
typedef struct {
...
* @param[in] handle                              is the handle of the current connection.
* @param[in] module_id                           is the module ID of the current user.
* @param[in] notification                         is the playing notification to notify the remote device.
* @return                                        #BT_STATUS_SUCCESS, the operation completed successfully.
*                                                #BT_STATUS_FAIL, the operation has failed.
*                                                #BT_STATUS_OUT_OF_MEMORY, out of memory.
*/
...
* @param[out] native_clock                           is the native clock.
* @return                                        #BT_STATUS_SUCCESS, the operation completed successfully.
*                                                #BT_STATUS_FAIL, the operation has failed.
*/
