...
typedef enum {
    ...
    BT_CODEC_MEDIA_LTCS_DATA_TIMEOUT,                     /**< Request to WPC PCDC SYNC. */
...
typedef struct _bt_media_handle_t {
    ...
    void (*set_gaming_mode_flag)(struct _bt_media_handle_t *handle, bool is_gaming);                   /**< Set the information of gaming mode flag. */
    void (*set_alc_mode_flag)(struct _bt_media_handle_t *handle, bool is_alc);                         /**< Set the information of ALC mode flag. */
    ...
    void (*set_start_asi)(struct _bt_media_handle_t *handle, uint32_t asi);                             /**< Set A2DP start ASI. */
    void (*set_start_bt_clk)(struct _bt_media_handle_t *handle, uint32_t bt_clk, uint32_t bt_intra_clk);/**< Set A2DP play en start BT clock. */


    /**< Disable side tone feature. */
} bt_media_handle_t;
...
typedef struct {
    ...
    uint8_t object_type;        /**< b0: M4-ELDv2, b1: M4 HE-AACv2, b2: M4 HE-AAC, b3: M4-scalable, b4: M4-LTP, b5: M4-LC, b6: M2-LC. */
    uint8_t channels;           /**< b0: 8(7.1), b1: 6(5.1), b2: 2, b3: 1. */
 ...
 */
typedef struct {
    uint16_t codec_id;          /**< Indicate codec id, default setting is 0xFF. */
...
#if defined(AIR_BT_CODEC_BLE_ENABLED) || defined(AIR_BLE_ULTRA_LOW_LATENCY_ENABLE)
/**
...
#define BT_CODEC_TYPE_LE_AUDIO_LC3       (0x01)               /**<  LC3 codec. */
#define BT_CODEC_TYPE_LE_AUDIO_LC3PULS   (0x02)               /**<  LC3PLUS codec. */
#define BT_CODEC_TYPE_LE_AUDIO_VENDOR    (0x03)               /**<  Vendor codec. */

typedef enum {
    LE_AUDIO_interval_1_25      = 0, /**< frame duration = 1.25ms  */
    LE_AUDIO_interval_2_5       = 1, /**< frame duration = 2.5ms  */
    LE_AUDIO_interval_5         = 2, /**< frame duration = 5ms  */
    LE_AUDIO_interval_7_5       = 3, /**< frame duration = 7.5ms  */
    LE_AUDIO_interval_10        = 4, /**< frame duration = 10ms  */
} le_audio_interval_t;
...
typedef struct {
    ...
    uint8_t   frame_duration;            /**< frame duration enum : le_audio_interval_t */
    uint16_t  maxframe_payload_length;   /**< Maximum frame length. unit: byte. */
    uint32_t  context_type;               /**<configuration enum : bt_le_audio_content_type_t . */
} bt_codec_le_audio_dl_t;
...
typedef struct {
    ...
    uint32_t  context_type;              /**<configuration enum : bt_le_audio_content_type_t . */
    bool      nr_offload_flag;           /**< ULL2.0 AINR offload flag*/
} bt_codec_le_audio_ul_t;

/** @brief This structure defines the LE Audio codec. */
typedef struct {
    uint8_t  channel_mode;              /**< 0: downlink only, 1: downlink and uplink. */
    bt_codec_le_audio_ul_t ul_param;
    bt_codec_le_audio_dl_t dl_param;
} bt_codec_le_audio_param_t;

#ifndef  BT_LE_AUDIO_ENABLE
/**
...
#endif
#define AUDIO_CONTENT_TYPE_WIRELESS_MIC         0x5678  /**< AIROHA proprietary Wireless mic.*/
