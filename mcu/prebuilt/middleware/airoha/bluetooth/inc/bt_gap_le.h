...
/**
 * @brief     This function is used to set the public address for advertising.
 * @param[in] param   is the advertising public address parameters #bt_hci_cmd_vendor_le_set_adv_public_addr_t.
 * @return    #BT_STATUS_SUCCESS, the operation completed successfully, otherwise it failed.
 */
bt_status_t bt_gap_le_set_adv_public_address(bt_hci_cmd_vendor_le_set_adv_public_addr_t *param);
