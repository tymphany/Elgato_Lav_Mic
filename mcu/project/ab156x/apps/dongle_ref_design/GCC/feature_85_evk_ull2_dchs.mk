...
#                         dongle : The side which is dongle. It supports surround audio.
#                         none   : Not a master or salve or dongle.
# It must be set to the same value for both DSP and MCU, otherwise, it will not work.
AIR_DUAL_CHIP_MIXING_MODE = dongle
...
AIR_PRODUCT_CATEGORY = AB1585_ULL2_DONGLE
