...
/**
 * File: app_i2s_idle_activity.h
 *
 * Description: This file defines the interface of app_i2s_idle_activity.c.
 */


#ifndef __APP_I2S_IDLE_ACTIVITY_H__
#define __APP_I2S_IDLE_ACTIVITY_H__

#include "ui_shell_activity.h"

/**
* @brief      This function is the interface of the app_i2s_idle_activity, and is only called by ui_shell framework when events are sent.
...
*/
bool app_i2s_idle_activity_proc(ui_shell_activity_t *self,
...
#endif /* __APP_I2S_IDLE_ACTIVITY_H__ */