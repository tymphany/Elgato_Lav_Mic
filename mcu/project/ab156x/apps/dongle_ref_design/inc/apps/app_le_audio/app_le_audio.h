...
/* Enable this feature option not to stop call mode when MIC0 port is disabled with call existing. */
#define AIR_LE_AUDIO_DO_NOT_STOP_CALL_MODE_WHEN_CALL_EXIST
#endif
