...
#define APP_LE_AUDIO_AIRD_ACTION_UPDATE_BREDR_CONNECTION_STATUS             10
...
/* AIRD BREDR connection status*/
#define APP_LE_AUDIO_AIRD_BREDR_CONNECTION_STATUS_DISCONNECTED  0x00
#define APP_LE_AUDIO_AIRD_BREDR_CONNECTION_STATUS_CONNECTED     0x01
typedef uint8_t app_le_audio_aird_bredr_connected_status_t;
