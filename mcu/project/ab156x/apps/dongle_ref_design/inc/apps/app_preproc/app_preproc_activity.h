...
/**
 * File: app_preproc_activity.h
 *
 * Description: This file defines the interface of app_preproc_activity.c.
 *
...
#ifndef __APP_PREPROC_ACTIVITY_H__
#define __APP_PREPROC_ACTIVITY_H__
