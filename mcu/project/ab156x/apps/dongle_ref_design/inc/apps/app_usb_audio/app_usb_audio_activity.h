...
/**
 * File: app_usb_audio_activity.h
 *
 * Description: This file defines the interface of app_usb_audio_activity.c.
 */
...
/**
* @brief      This function is the interface of the app_usb_audio_activity, and is only called by ui_shell framework when events are sent.
