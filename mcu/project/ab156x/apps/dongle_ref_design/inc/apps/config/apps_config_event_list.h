...
typedef enum {
    ...
    KEY_STOP_DISCOVERABLE = 0x0003,                 /**< Stop BT discoverable. */
    ...
    KEY_ULL_AIR_PAIRING = 0x0099,       /**< Start ULL air pairing. */
    KEY_EQ_ON = 0x009A,                 /**< Enable the EQ. */
    KEY_EQ_OFF = 0x009B,                /**< Disable the EQ. */
    KEY_EQ_SWITCH = 0x009C,             /**< Switch the EQ. */
    ...
    KEY_DONGLE_CONTROL_RECORD = 0x0160,                 /* On dongle side control headset side record. */
    KEY_DONGLE_CONTROL_MUTE_MIC = 0x0161,               /* On dongle side control headset side mute mic. */
    KEY_DONGLE_SWITCH_SPLIT_MERGE_MODE = 0x0168,        /* On dongle side to switch MIC split mode and merge mode. */
    KEY_DONGLE_SWITCH_SAFETY_MODE = 0x0169,             /* On dongle side to switch safety mode. */

    KEY_DONGLE_CONTROL_SWITCH_DONGLE_MODE= 0x0170,      /* Control gaming/xbox/enterprise/... mode. */
