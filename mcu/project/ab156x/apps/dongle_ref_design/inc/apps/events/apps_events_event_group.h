...
typedef enum {
    ...
    EVENT_GROUP_UI_SHELL_XBOX = 40,         /**< group for XBOX events */
    ...
    EVENT_GROUP_UI_SHELL_SWIFT_PAIR,        /**< group for USB HID call */
    EVENT_GROUP_UI_SHELL_SELF_FITTING,      /**< group for the self fitting */
    EVENT_GROUP_UI_SHELL_APP_DONGLE_LE_RACE,   /**< group for race cmd of LE audio. */
    EVENT_GROUP_UI_SHELL_APP_DONGLE_RACE,       /**< group for race cmd of dongle. */
