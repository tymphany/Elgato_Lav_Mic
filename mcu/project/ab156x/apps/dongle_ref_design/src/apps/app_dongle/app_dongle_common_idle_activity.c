...
static const int32_t apps_usb_8ch_mic_sample_rate_alt1[USB_AUDIO_DSCR_MAX_FREQ_NUM] __unused = {
    USB_AUDIO_SAMPLE_RATE_16K,
...
static const int32_t apps_usb_8ch_mic_sample_rate_alt2[USB_AUDIO_DSCR_MAX_FREQ_NUM] __unused = {
    USB_AUDIO_SAMPLE_RATE_16K,
    USB_AUDIO_SAMPLE_RATE_32K,
    USB_AUDIO_NULL,
    USB_AUDIO_NULL,
    ...
    switch(s_dongle_mode) {
        ...
        case APPS_USB_MODE_8CH: {
            ...
            USB_Aduio_Set_TX1_Alt1(USB_AUDIO_SAMPLE_RATE_NUM_3,
                                   USB_AUDIO_SAMPLE_SIZE_16BIT,
                                   USB_AUDIO_CHANNEL_1,
                                   (uint32_t *)apps_usb_8ch_mic_sample_rate_alt1);

            USB_Aduio_Set_TX1_Alt2(true,
                                    USB_AUDIO_SAMPLE_RATE_NUM_2,
                                    USB_AUDIO_SAMPLE_SIZE_24BIT,
                                    USB_AUDIO_CHANNEL_1,
                                    (uint32_t *)apps_usb_8ch_mic_sample_rate_alt2);
        }
#endif
        default:
            break;
