 ...
 */
#include "app_i2s_idle_activity.h"
#include "apps_events_event_group.h"
#include "apps_events_i2s_in_event.h"


static bool app_i2s_handle_system_event(ui_shell_activity_t *self,
                                        uint32_t event_id,
                                        void *extra_data,
                                        size_t data_len)
{
...
/*========================================================================================*/
bool app_usb_i2s_activity_proc(ui_shell_activity_t *self,
                               ...
                               size_t data_len)
{
    ...
    switch (event_group) {
        case EVENT_GROUP_UI_SHELL_SYSTEM:
            ...
            ret = app_i2s_handle_system_event(self, event_id, extra_data, data_len);
            break;
        default:
            break;
    }
