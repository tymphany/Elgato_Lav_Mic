...
static bt_status_t app_le_audio_bcst_config_extend_adv(void)
{
    ...
    ea_data.data[idx++] = BT_PBP_FEATURE_BROADCAST_STREAM_ENCRYPTED | BT_PBP_FEATURE_SQ_CONFIGRATION_PRESENT | BT_PBP_FEATURE_HQ_CONFIGRATION_PRESENT;
...
static uint8_t app_le_audio_bcst_get_periodic_adv_data(uint8_t *p_pa, uint8_t pa_len)
{
    ...
    uint8_t pa_level_1[] = {
        ...
        /* Level 1 */
        0x00, 0x00, 0x00,   /* Presentation_Delay */
        0x01,               /*Num_Subgroups*/
    };
