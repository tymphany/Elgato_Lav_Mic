...
void app_line_in_set_volume(uint8_t volume)
{
    ...
    if (ctx->started) {
        ...
        config.wired_audio_runtime_config.vol_level.vol_level[0] = volume;
        config.wired_audio_runtime_config.vol_level.vol_level[1] = volume;
...
static void __app_line_in_out_set_transmitter_volume(TRANSMITTER_USR_T type)
{
    ...
    config.wired_audio_runtime_config.vol_level.vol_level[0] = ctx->mute ? 0 : (uint8_t)s_line_in_volume;
    config.wired_audio_runtime_config.vol_level.vol_level[1] = ctx->mute ? 0 : (uint8_t)s_line_in_volume;
