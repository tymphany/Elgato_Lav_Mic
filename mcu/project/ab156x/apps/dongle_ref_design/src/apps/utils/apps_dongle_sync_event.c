...
bt_status_t apps_dongle_sync_event_send_extra_with_addr(uint32_t event_group,
                                                        uint32_t event_id,
                                                        void *extra_data,
...
{
    return apps_dongle_sync_event_send_extra_with_addr(event_group, event_id, extra_data, extra_data_len, NULL);
}
