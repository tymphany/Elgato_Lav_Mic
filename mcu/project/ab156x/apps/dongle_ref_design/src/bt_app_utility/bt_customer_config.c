...
#if defined(AIR_BT_ULTRA_LOW_LATENCY_ENABLE) || defined(AIR_BLE_AUDIO_DONGLE_ENABLE)
...
#define BT_SINK_SRV_CM_DB_COD   0x24050C                                /* Default BT COD(Class Of Device) refer to BT spec. */
