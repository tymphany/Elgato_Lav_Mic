...
#endif
#if defined (RACE_FOTA_DFU_LE_ACTIVE_MODE_SUPPORT) && defined (AIR_LE_AUDIO_ENABLE)
...
#ifdef RACE_FOTA_DFU_LE_ACTIVE_MODE_SUPPORT
#ifdef AIR_LE_AUDIO_UNICAST_ENABLE
    app_le_audio_ucst_pause_ex(APP_LE_AUDIO_UCST_PAUSE_STREAM_DONGLE_FOTA);
#endif
#endif
...
#ifdef RACE_FOTA_DFU_LE_ACTIVE_MODE_SUPPORT
#ifdef AIR_LE_AUDIO_UNICAST_ENABLE
    app_le_audio_ucst_resume_ex(APP_LE_AUDIO_UCST_PAUSE_STREAM_DONGLE_FOTA);
#endif
#endif
