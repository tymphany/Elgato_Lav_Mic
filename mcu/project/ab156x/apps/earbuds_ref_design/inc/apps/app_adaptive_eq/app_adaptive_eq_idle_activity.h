...
/**
 * File: app_adaptive_eq_idle_activity.h
 *
 * Description: This file defines the interface of app_adaptive_eq_idle_activity.c.
 */

#ifndef __APP_ADAPTIVE_EQ_IDLE_ACTIVITY_H__
#define __APP_ADAPTIVE_EQ_IDLE_ACTIVITY_H__
...
#endif
/**
* @brief      This function is to get if the adaptive eq transmitter  is running.
* @return     If return true, the adaptive eq is running.
*/
...
#endif
#endif /* __APP_ADAPTIVE_EQ_IDLE_ACTIVITY_H__ */
