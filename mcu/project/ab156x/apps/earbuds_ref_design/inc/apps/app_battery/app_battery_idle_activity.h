...
/**
 * File: app_battery_idle_activity.h
 *
 * Description: This file defines the interface of app_battery_idle_activity.c.
 *
 * Note: See doc/AB1565_AB1568_Earbuds_Reference_Design_User_Guide.pdf for more detail.
 *
 */

#ifndef __APP_BATTERY_IDLE_ACTIVITY_H__
#define __APP_BATTERY_IDLE_ACTIVITY_H__

#include "ui_shell_activity.h"

/**
* @brief      This function is the interface of the app_battery_idle_activity, and is only called by ui_shell when events are sent.
