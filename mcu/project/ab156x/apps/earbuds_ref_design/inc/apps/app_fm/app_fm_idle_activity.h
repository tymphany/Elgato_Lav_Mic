...
/**
 * File: app_fm_idle_activity.h
 *
 * Description: This file defines the interface of app_fm_idle_activity.c.
 *
...
#ifndef __APP_FIND_ME_IDLE_ACTIVITY_H__
#define __APP_FIND_ME_IDLE_ACTIVITY_H__
...
/**
* @brief      This function is the interface of the app_fm_idle_activity, and is only called by ui_shell when events are sent.
