...
/**
 * File: app_hfp_idle_activity.h
 *
 * Description: This file defines the interface of app_hfp_idle_activity.c.
 *
...
#ifndef __APP_HFP_IDLE_ACTIVITY_H__
#define __APP_HFP_IDLE_ACTIVITY_H__
...
#define APP_HFP_IDLE "[HFP_APP]idle"

/**
  * @brief                            This function is used to hfp debug.
  */
void app_hfp_atci_debug_init(void);

/**
* @brief      This function is the interface of the app_hfp_idle_activity, and is only called by ui_shell framework when events are sent.
