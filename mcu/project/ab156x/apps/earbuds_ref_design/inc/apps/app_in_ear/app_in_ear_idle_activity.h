...
/**
 * File: app_in_ear_idle_activity.h
 *
 * Description: This file defines the interface of app_in_ear_idle_activity.c.
 *
...
#ifndef __APP_IN_EAR_IDLE_ACTIVITY_H__
#define __APP_IN_EAR_IDLE_ACTIVITY_H__
...
/**
* @brief      This function is the interface of the app_in_ear_idle_activity, and is only called by ui_shell framework when events are sent.
