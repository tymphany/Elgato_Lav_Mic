...
/**
 * File: app_le_audio_bis_activity.h
 *
 * Description: This file defines the interface of app_le_audio_bis_activity.c.
 *
 */

#ifndef __APP_LE_AUDIO_BIS_ACTIVITY_H__
#define __APP_LE_AUDIO_BIS_ACTIVITY_H__
...
/**
* @brief      This function is the interface of the app_le_audio_bis_activity.c, and is only called by ui_shell framework when events are sent.
...
#endif /* __APP_LE_AUDIO_BIS_ACTIVITY_H__ */
