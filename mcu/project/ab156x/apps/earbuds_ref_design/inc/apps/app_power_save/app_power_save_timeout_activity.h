...
/**
 * File: app_power_save_timeout_activity.h
 *
 * Description: This file defines the interface of app_power_save_timeout_activity.c.
 *
 * Note: See doc/AB1565_AB1568_Earbuds_Reference_Design_User_Guide.pdf for more detail.
 *
 */

#ifndef __APP_POWER_SAVE_TIMEOUT_ACTIVITY__
#define __APP_POWER_SAVE_TIMEOUT_ACTIVITY__
...
/**
* @brief      This function is the interface of the app_power_save_timeout_activity, and is only called by ui_shell when events are sent.
...
#endif /* __APP_POWER_SAVE_TIMEOUT_ACTIVITY__ */
