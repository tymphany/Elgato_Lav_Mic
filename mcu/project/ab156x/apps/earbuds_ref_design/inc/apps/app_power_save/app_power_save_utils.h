...
#if defined(AIR_DUAL_CHIP_MIXING_MODE_ROLE_MASTER_ENABLE) && defined(AIR_SILENCE_DETECTION_ENABLE)
/**
...
/**
* @brief      This function is used to notify app that the power saving ull2 streamming state.
* @return     None.
*/
