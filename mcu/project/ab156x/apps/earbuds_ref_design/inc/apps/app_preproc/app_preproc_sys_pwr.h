...
/**
 * File: app_preproc_sys_pwr.h
 *
 * Description: This file defines the interface of app_preproc_sys_pwr.c.
 *
 * Note: See doc/AB1565_AB1568_Earbuds_Reference_Design_User_Guide.pdf for more detail.
 *
 */

#ifndef __APP_PREPROC_SYS_PWR_H__
#define __APP_PREPROC_SYS_PWR_H__

#include "ui_shell_activity.h"

/**
* @brief      This function is used to handle SYSTEM_POWER events.
...
*/
bool sys_pwr_component_event_proc(ui_shell_activity_t *self,
                                  uint32_t event_id,
                                  void *extra_data,
                                  size_t data_len);

#endif /* __APP_PREPROC_SYS_PWR_H__ */
