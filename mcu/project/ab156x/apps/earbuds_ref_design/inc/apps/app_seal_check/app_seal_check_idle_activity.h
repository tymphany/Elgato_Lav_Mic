...
/**
 * File: app_seal_check_idle_activity.h
 *
 * Description: This file defines the interface of app_leakage_detection_idle_activity.c.
 *
...
#ifndef __APP_LEAKAGE_DETECTION_IDLE_ACTIVITY_H__
#define __APP_LEAKAGE_DETECTION_IDLE_ACTIVITY_H__
...
/**
* @brief      This function is the interface of the app_leakage_detection_idle_activity, and is only called by ui_shell framework when events are sent.
...
#endif /*__APP_LEAKAGE_DETECTION_IDLE_ACTIVITY_H__*/
