...
/**
 * @brief Send broadcast of the ongoing status of leakage detection.
 * @param[in] is_from_irq, indicates whether this function is called in the interrupt service function.
 * @param[in] is_ongoing, leakage detection is ongoing or not.
 * @return      None.
 */
