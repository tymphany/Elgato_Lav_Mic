...
/**
 * File: app_self_fitting_idle_activity.h
 *
 * Description: This file defines the interface of app_self_fitting_idle_activity.c.
 */

#ifndef __APP_SELF_FITTING_IDLE_ACTIVITY_H__
#define __APP_SELF_FITTING_IDLE_ACTIVITY_H__
...
/**
* @brief      This function is the interface of the app_self_fitting_idle_activity_proc, and is only called by ui_shell when events are sent.
...
#endif //AIR_ADVANCED_PASSTHROUGH_ENABLE_V2
#endif /* __APP_SELF_FITTING_IDLE_ACTIVITY_H__ */
