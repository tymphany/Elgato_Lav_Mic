...
/**
 * File: app_share_activity.h
 *
 * Description: This file defines the interface of app_share_activity.c.
 *
...
/**
* @brief      This function is the interface of the app_share_activity, and is only called by ui_shell framework when events are sent.
