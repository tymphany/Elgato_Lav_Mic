...
/**
 * File: app_smcharger_off_activity.h
 *
 * Description: This file defines the interface of app_smcharger_off_activity.c. (OFF State)
 *
...
#ifndef __APP_SMCHARGER_OFF_ACTIVITY_H__
#define __APP_SMCHARGER_OFF_ACTIVITY_H__
...
/**
* @brief      This function is the interface of the app_smcharger_off_activity, and is only called by ui_shell when events are sent.
...
*/
bool app_smcharger_off_activity_proc(struct _ui_shell_activity *self,
