...
/**
 * File: app_smcharger_startup_activity.h
 *
 * Description: This file defines the interface of app_smcharger_startup_activity.c. (STARTUP State)
 *
...
#ifndef __APP_SMCHARGER_STARTUP_ACTIVITY_H__
#define __APP_SMCHARGER_STARTUP_ACTIVITY_H__
...
/**
* @brief      This function is the interface of the app_smcharger_startup_activity, and is only called by ui_shell when events are sent.
...
*/
bool app_smcharger_startup_activity_proc(struct _ui_shell_activity *self,
