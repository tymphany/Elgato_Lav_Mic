...
/**
 * File: app_va_xiaowei_transient_activity.h
 *
 * Description: This file defines the interface of app_va_xiaowei_transient_activity.c.
 *
 */

#ifndef __APP_VA_XIAOWEI_TRANSIENT_ACTIVITY_H__
#define __APP_VA_XIAOWEI_TRANSIENT_ACTIVITY_H__
...
/**
* @brief      This function is the interface of the app_va_xiaowei_transient_activity, and is only called by ui_shell framework when events are sent.
...
#endif /* __APP_VA_XIAOWEI_TRANSIENT_ACTIVITY_H__ */
