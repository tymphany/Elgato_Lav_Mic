...
#define log_msgid_bt_fatal(_message,...)    LOG_MSGID_E(bt, (_message), ##__VA_ARGS__)
#define log_msgid_bt_error(_message,...)    LOG_MSGID_W(bt, (_message), ##__VA_ARGS__)
#define log_msgid_bt_info(_message,...)     LOG_MSGID_I(bt, (_message), ##__VA_ARGS__)
