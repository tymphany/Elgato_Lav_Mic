...
AIR_USB_HID_CALL_CTRL_ENABLE = y
...
AIR_ECNR_CONFIG_TYPE = 3RD_PARTY_AI_NR_SHORT_BOOM_OO
...
# This option is to enable device matched with LE Audio dongle multi-device scenario.
# Dependency: AIR_LE_AUDIO_ENABLE must be enabled when this option is set to y.
AIR_LE_AUDIO_QUICK_RECONN_ENABLE = y

# This option is to enable/disable Custom Pairing feature.
AIR_CUST_PAIR_ENABLE = y
