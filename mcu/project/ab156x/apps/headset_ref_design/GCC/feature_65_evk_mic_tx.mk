...
# It must be turned on/off for both DSP and MCU, otherwise, it will not work. No support for earbuds project.
AIR_USB_AUDIO_IN_AND_BT_MIX_ENABLE = y
...
# It must be turned on/off for both DSP and MCU, otherwise, it will not work.
AIR_AUDIO_LC3PLUS_CODEC_ENABLE = y
...
# This option is used to enable lc3plus codec
AIR_AUDIO_LC3PLUS_CODEC_ENABLE = y

# This option is used to enable opus codec
AIR_AUDIO_VEND_CODEC_ENABLE = n
######  System ######
...
# This option is to enable/disable wireless mic.
# Dependency: AIR_BLE_ULTRA_LOW_LATENCY_ENABLE be enabled.
# It must be turned on/off for both DSP and MCU, otherwise, it will not work.
AIR_WIRELESS_MIC_ENABLE = y

# This option is to enable/disable the detachable mic.
AIR_AUDIO_DETACHABLE_MIC_ENABLE = y

# This option is to enable/disable the advanced record.
AIR_RECORD_ADVANCED_ENABLE = y
...
AIR_MCU_LINKER_SCRIPT_FILE = ab156x_flash_mic_tx.ld
...
AIR_PRODUCT_CATEGORY = AB1565_Headset
