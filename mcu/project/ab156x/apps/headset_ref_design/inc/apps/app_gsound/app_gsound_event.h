...
/**
 * File: app_gsound_event.h
 */

#ifndef __APP_GSOUND_EVENT_H__
#define __APP_GSOUND_EVENT_H__
...
/**
 * @brief GSound events about connection
 */
enum {
    ...
    APPS_EVENT_GSOUND_POWER_OFF_SYNC
};
