...
#ifndef __APP_HID_CALL_H__
#define __APP_HID_CALL_H__
...
/**
* @brief      This function is the interface of the app_hid_call_idle_activity_proc, and is only called by ui_shell framework when events are sent.
