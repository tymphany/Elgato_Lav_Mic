...
/**
 * File: app_rho_idle_activity.h
 *
 * Description: This file defines the interface of app_rho_idle_activity.c.
 *
 */

#ifndef __APP_RHO_IDLE_ACTIVITY_H__
#define __APP_RHO_IDLE_ACTIVITY_H__

#include "ui_shell_activity.h"

/**
 *  @brief This enum defines the result of RHO APP.
 */
typedef enum {
    APP_RHO_RESULT_SUCCESS,
    APP_RHO_RESULT_FAIL
} app_rho_result_t;

/**
* @brief      This function is the interface of the app_rho_idle_activity, and is only called by ui_shell when events are sent.
...
#endif /* __APP_RHO_IDLE_ACTIVITY_H__ */
