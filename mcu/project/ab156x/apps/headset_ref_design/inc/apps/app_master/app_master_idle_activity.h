...
#ifndef __APP_MASTER_IDLE_ACTIVITY_H__
#define __APP_MASTER_IDLE_ACTIVITY_H__
...
/**
* @brief      This function is the interface of the app_master_idle_activity, and is only called by ui_shell when events are sent.
...
#endif /* __APP_MASTER_IDLE_ACTIVITY_H__ */
