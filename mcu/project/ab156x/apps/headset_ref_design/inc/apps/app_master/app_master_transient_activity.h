...
#ifndef __APP_MASTER_TRANSIENT_ACTIVITY_H__
#define __APP_MASTER_TRANSIENT_ACTIVITY_H__
...
/**
* @brief      This function is the interface of the app_master_transient_activity, it processes the key events and display LED when slave MMI state is idle.
...
#endif /* __APP_MASTER_TRANSIENT_ACTIVITY_H__ */
