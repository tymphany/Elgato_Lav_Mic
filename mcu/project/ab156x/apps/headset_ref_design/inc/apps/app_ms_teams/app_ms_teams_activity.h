...
#ifndef __APP_MS_TEAMS_ACTIVITY_H__
#define __APP_MS_TEAMS_ACTIVITY_H__

#include "ui_shell_activity.h"
#include "ui_shell_manager.h"

/**
* @brief      This function is the interface of the app_ms_teams_activity, and is only called by ui_shell framework when events are sent.
...
*/
bool app_ms_teams_activity_proc(ui_shell_activity_t *self,
