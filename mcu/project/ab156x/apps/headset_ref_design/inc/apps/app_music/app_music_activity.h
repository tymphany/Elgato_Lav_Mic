...
/**
 * File: app_music_activity.h
 *
 * Description: This file defines the interface of app_music_activity.c.
 *
...
#ifndef __UI_SHELL_APP_MUSIC_ACTIVITY__
#define __UI_SHELL_APP_MUSIC_ACTIVITY__
...
#define APP_MUSIC_ACTI "[Music_APP]activity"

#ifdef MTK_APP_MUSIC_ENABLE
#define __APP_MUSIC_SUPPORT__
#endif


/**
* @brief      This function is the interface of the app_music_activity, and is only called by ui_shell framework when events are sent.
...
#endif /* __UI_SHELL_APP_MUSIC_ACTIVITY__ */
