...
#ifndef __UI_SHELL_ULL_TAKEOVER_H__
#define __UI_SHELL_ULL_TAKEOVER_H__
#if defined(AIR_BLE_ULTRA_LOW_LATENCY_ENABLE) && defined(AIR_BLE_ULL_TAKEOVER_ENABLE)
#ifdef __cplusplus
extern "C" {
#endif

/**
* @brief      This function is the interface of the app_ull_takeover_activity, and is only called by ui_shell when events are sent.
...
#endif
#endif /* __UI_SHELL_ULL_TAKEOVER_H__ */
