...
/**
 * File: app_audio_manager_idle_activity.h
 *
 * Description: This file defines the interface of app_audio_manager_idle_activity.c.
 *
 */
#ifndef __APP_AUDIO_TRANS_MGR_IDLE_ACTIVITY_H__
#define __APP_AUDIO_TRANS_MGR_IDLE_ACTIVITY_H__
...
/**
* @brief      This function is the interface of the app_audio_manager_idle_activity, and is only called by ui_shell framework when events are sent.
...
#endif /* __APP_AUDIO_MANAGER_IDLE_ACTIVITY_H__ */
