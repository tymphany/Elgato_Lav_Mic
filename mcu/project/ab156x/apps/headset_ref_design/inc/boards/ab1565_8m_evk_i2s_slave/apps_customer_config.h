...
#define APPS_USB_ENT_PID 0x0809
...
#define APPS_USB_GAME_PID 0x080B
...
#define APPS_DEFAULT_USB_MODE           (APPS_USB_MODE_WIRELESS_MIC_TX)
#elif defined(AIR_DCHS_MODE_ENABLE) || defined(AIR_USB_AUDIO_MULTI_CH_MODE)
#define APPS_DEFAULT_USB_MODE           (APPS_USB_MODE_8CH)
#elif defined(AIR_BLE_ULTRA_LOW_LATENCY_ENABLE) || defined(AIR_BT_ULTRA_LOW_LATENCY_ENABLE)
...
#else
#define APPS_DEFAULT_USB_MODE           (APPS_USB_MODE_IOT)
#endif
