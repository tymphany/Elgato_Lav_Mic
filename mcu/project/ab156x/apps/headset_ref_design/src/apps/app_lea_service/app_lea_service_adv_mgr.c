...
static uint32_t app_lea_adv_mgr_get_adv_data_internal(multi_ble_adv_info_t *adv_data)
{
    ...
    if ((NULL != adv_data->adv_data) && (NULL != adv_data->adv_data->data)) {
        ...
        adv_data->adv_data->data[len] = 11;
        adv_data->adv_data->data[len + 1] = BT_GAP_LE_AD_TYPE_MANUFACTURER_SPECIFIC;
        adv_data->adv_data->data[len + 2] = 0x94; /* Airoha Technology UUID */
        adv_data->adv_data->data[len + 3] = 0x00;
        adv_data->adv_data->data[len + 4] = 7;/* Length of RSI adv_data */
        adv_data->adv_data->data[len + 5] = 0x2E;/* Type of RSI adv_data */
        ble_csis_get_rsi(rsi);
        memcpy(&adv_data->adv_data->data[len + APP_LE_AUDIO_RSI_LENGTH], rsi, sizeof(rsi));
        len += 12;
