...
const apps_config_configurable_event_status_table_t s_key_config_event_sta_maps[] = {
...
#ifdef AIR_MULTI_POINT_ENABLE
    {
        ...
        (1 << APP_BT_OFF) | (1 << APP_DISCONNECTED) | (1 << APP_CONNECTABLE) | (1 << APP_CONNECTED) | (1 << APP_HFP_CALLACTIVE)
    ...
    {
        KEY_WM_CONTROL_LOCAL_RECORDER,
        (1 << APP_BT_OFF) | (1 << APP_DISCONNECTED) | (1 << APP_CONNECTABLE) | (1 << APP_CONNECTED) | (1 << APP_HFP_INCOMING)
        | (1 << APP_HFP_OUTGOING) | (1 << APP_HFP_CALLACTIVE) | (1 << APP_HFP_CALLACTIVE_WITHOUT_SCO) | (1 << APP_HFP_TWC_INCOMING)
        | (1 << APP_HFP_TWC_OUTGOING) | (1 << APP_HFP_MULTITPART_CALL) | (1 << APP_A2DP_PLAYING) | (1 << APP_STATE_HELD_ACTIVE)
        | (1 << APP_STATE_FIND_ME) | (1 << APP_ULTRA_LOW_LATENCY_PLAYING) | (1 << APP_WIRED_MUSIC_PLAY)
        | (1 << APP_LE_AUDIO_BIS_PLAYING) | (1 << APP_STATE_VA)
...
const apps_config_key_event_map_t temp_key_long_press1_configs[] = {
#ifdef AIR_MS_TEAMS_ENABLE
    {
        ...
        (1 << APP_DISCONNECTED) | (1 << APP_CONNECTABLE) | (1 << APP_CONNECTED) | (1 << APP_A2DP_PLAYING) | (1 << APP_HFP_CALLACTIVE_WITHOUT_SCO)
        | (1 << APP_ULTRA_LOW_LATENCY_PLAYING) | (1 << APP_WIRED_MUSIC_PLAY) | (1 << APP_HFP_CALLACTIVE) | (1 << APP_STATE_HELD_ACTIVE)
    },
    {
        EINT_KEY_0,
