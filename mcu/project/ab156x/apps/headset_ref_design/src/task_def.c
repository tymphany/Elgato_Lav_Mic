...
extern void ui_realtime_task(void *arg);
#endif

static const tasks_list_t tasks_list[] = {
#ifdef AIR_PROMPT_SOUND_ENABLE
    { ui_realtime_task, UI_REALTIME_TASK_NAME,   UI_REALTIME_TASK_STACKSIZE,  NULL,  UI_REALTIME_TASK_PRIO },
#endif
...
#ifdef AIR_GSOUND_ENABLE
    { gsound_target_task_main, GSOUND_TARGET_TASK_NAME, GSOUND_TARGET_TASK_STACKSIZE, NULL, GSOUND_TARGET_TASK_PRIORITY},
#endif
#ifdef AIR_AMA_ENABLE
...
#endif
#ifdef AIR_CUST_PAIR_ENABLE
    { cust_pair_task_main, CUST_PAIR_TASK_NAME, CUST_PAIR_TASK_STACKSIZE, NULL, CUST_PAIR_TASK_PRIORITY},
#endif
#ifdef AIR_WIRELESS_MIC_ENABLE
...
void task_def_init(void)
{
    ...
    audio_dsp0_nvdm_init();     // write the default nvdm data to flash memory.     hhhh
